...
- La machine à voyager dans les nuages (Streamlit),
...
Et si t'as des idées d'attractions pour les prochaines revues de presse, n'hésites pas à venir les partager via [notre formulaire de contribution](https://github.com/geotribu/website/issues/new?assignees=aurelienchaumet%2Cguts%2Cigeofr&labels=contribution+externe%2Crdp%2Ctriage&template=RDP_NEWS.yml).
...
![news CNES](https://cdn.geotribu.fr/img/logos-icones/entreprises_association/cnes.jpg "logo CNES"){: .img-rdp-news-thumb }
