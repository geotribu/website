...
[H2GIS](http://www.h2gis.org/), l'équivalent de PostGIS pour le système de base de données [H2](https://www.h2database.com/) (un SGBD en pur Java) sort en version 2. Développé dans le cadre du logiciel SIG open-source [OrbiGIS](https://orbisgis.org/), porté par le CNRS et qu'on vous [présentait en... 2009](/articles/2009/art_2009-11-26/), cette mise à jour permet d'être compatible avec la version 2 de H2 (vous suivez ?).
