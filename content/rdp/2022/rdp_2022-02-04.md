...
[![GRASS GIS 8 - Interface graphique](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/grass-gis/grass8_interface.png "GRASS GIS 8 - Interface graphique"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/grass-gis/grass8_interface.png "GRASS GIS 8 - Interface graphique"){: data-mediabox="gallery-lightbox" data-title="GRASS GIS 8 - Interface graphique" }

### H2GIS 2.0.0

![logo OrbiGIS](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/orbigis.jpg "logo OrbiGIS"){: .img-rdp-news-thumb }

[H2GIS](http://www.h2gis.org/), l'équivalent de PostGIS pour le système de base de données [H2](https://www.h2database.com/) (un SGBD en pur Java) sort en version 2. Développé dans le cadre du logiciel SIG open-source [OrbisGIS](https://orbisgis.org/), porté par le CNRS et qu'on vous [présentait en... 2009](/articles/2009/art_2009-11-26/), cette mise à jour permet d'être compatible avec la version 2 de H2 (vous suivez ?).
...
[![Bertin-js](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/bertin-js.png "Bertin.js"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/bertin-js.png "Bertin.js"){: data-mediabox="gallery-lightbox" data-title="Bertin.js" }
...
[![Timelapse](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/timelapse-online.png "Timelapse"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/timelapse-online.png "Timelapse"){: data-mediabox="gallery-lightbox" data-title="Timelapse" }
...
[![Streamlit example](https://github.com/giswqs/data/raw/main/timelapse/goes.gif "Streamlit example"){: .img-center loading=lazy }](https://github.com/giswqs/data/raw/main/timelapse/goes.gif "Streamlit example"){: data-mediabox="gallery-lightbox" data-title="Streamlit example" }
...
![logo La Gazette des Communes](https://cdn.geotribu.fr/img/logos-icones/entreprises_association/lagzette.png "logo La Gazette des Communes"){: .img-rdp-news-thumb }
...
La date de la 5ème édition des [GéoDataDays](https://www.geodatadays.fr) a été annoncée, l'évènement se déroulera le 14 et 15 septembre 2020 au [Futuroscope de Poitiers](https://www.openstreetmap.org/way/42553003) et vous pourrez vous inscrire dès le mois de Mars. :calendar:

[![GéoDataDays 2022](https://cdn.geotribu.fr/img/articles-blog-rdp/evenement/2022_geodatadays.jpg "GéoDataDays 2022"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/evenement/2022_geodatadays.jpg "GéoDataDays 2022"){: data-mediabox="gallery-lightbox" data-title="GéoDataDays 2022" }
...
![icône pompiers](https://cdn.geotribu.fr/img/logos-icones/divers/pompier.png "icône pompiers"){: .img-rdp-news-thumb }
