...
Après Graticule et Khartis, l'Atelier Cartographique de Sciences Po est de retour avec Topohelper! Il s'agit d'une bibliothèque javascript permettant de manipuler facilement des fichiers TopoJSON. Pour en savoir plus sur cette librairie, on vous recommande de consulter le github dédié, la mise en bouche ainsi que la documentation. Son créateur Thomas Ansart est preneur de vos commentaires.
