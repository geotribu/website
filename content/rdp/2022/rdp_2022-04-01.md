...
L'outil est toujours en cours de développement (voir [le dépôt GitHub](https://github.com/etalab/catalogage-donnees/)) mais dispose d'une [instance de démonstration](demo@catalogue.data.gouv.fr) (compte : `demo@catalogue.data.gouv.fr` / `demo`) permettant de se faire une idée au fur et à mesure de l'avancée du projet.
