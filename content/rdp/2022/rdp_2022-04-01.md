...
comments: true
date: 2022-04-01
description: 'Géodésie vulgarisée, cartes dessinnées, nouvelle version d''OTB, des tutoriels ArqGIS détaillés, GéoRivière publiée, geOcom programmé, un nouvel horizon pour les métadonnées : la GeoRDP libérée !'
...
Les étudiants du Master SIGAT ont réalisé et [partagé par l’intermédiaire de leur enseignant](https://twitter.com/borismericskay?s=21) une série de tutoriels sur ArqGIS :

1. [Création d’un plugin ArqGIS](https://docs.google.com/presentation/d/1Xsi2gF-hKJT1YHfKgEtx4b-wwwgO6l4mfl1zUIZgLtE/edit?usp=sharing)
...
![ArqGIS - analyse réseau](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/qgis/qgis_analyse_reseau_sigat.jpeg "ArqGIS - analyse réseau"){: .img-center loading=lazy }
...
Le service de cartographie du journal [Le Monde](https://www.lemonde.fr/) nous [montre dans un thread Twitter le dessous de sa carte de Mykolaïv parue dans l'édition papier cette semaine](https://twitter.com/LM_enCartes/status/1509559583269916672) : quel est le process, qui intervient, avec quels outils. Un bon rappel que la conception et la réalisation d'une carte représente un travail conséquent et minutieux. Et aussi que les logiciels de SIG libres sont partout (ArqGIS inside) !
