...
image: "https://cdn.geotribu.fr/img/sketchy.png"
license: default
robots: index, follow
tags:
    - Géotuileur
...
Bien qu'il y ait de l'eau dans le gaz sur certaines parties du globe comme nous le montre cette image satellite partagée par Airbus, on tient à rassurer nos lecteurs le pipeline de l'actualité géomatique est toujours opérationnel et vous êtes toujours [les bienvenus pour l'alimenter](https://github.com/geotribu/website/issues/new/choose) :hugging:.

Bonne lecture.

<blockquote class="twitter-tweet tw-align-center" data-dnt="true"><p lang="en" dir="ltr"><a href="https://twitter.com/hashtag/NordStream?src=hash&amp;ref_src=twsrc%5Etfw">#NordStream</a> gas pipeline leak seen from space 🛰.<br>📍 Baltic sea. <a href="https://t.co/wUab6VFpTI">pic.twitter.com/wUab6VFpTI</a></p>&mdash; Airbus Space (@AirbusSpace) <a href="https://twitter.com/AirbusSpace/status/1575523892063608832?ref_src=twsrc%5Etfw">September 29, 2022</a></blockquote>
...
L'[IGN lance son Géotuileur](https://geoservices.ign.fr/actualites/2022-10-06-geotuileur) pour transformer facilement vos données géographiques en tuiles vectorielles et les diffusez depuis une interface dédiée. Les avantages de la solution :
...
Le Géotuileur est accessible [ici](https://www.ign.fr/geoplateforme/geotuileur/) et dispose également d'un [plugin QGIS](https://oslandia.gitlab.io/qgis/ign-geotuileur/usage/installation.html) pour simplifier la publication de vos données (:warning: le stockage et le nombre de services est limité).

!!! info "Géoplateforme"
    A noter que le Géotuileur est une expérimentation de l'API Entrepôt de la Géoplateforme.

[![Géotuileur](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/IGN-Geotuileur-Visuel.png "Géotuileur"){: .img-center loading=center }](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/IGN-Geotuileur-Visuel.png){: data-mediabox="lightbox-gallery" data-title="Géotuileur" }
...
[![SAGEO 2023](https://cdn.geotribu.fr/img/articles-blog-rdp/evenement/2023_SAGEO.png "SAGEO 2023"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/evenement/2023_SAGEO.png){: data-mediabox="lightbox-gallery" data-title="SAGEO 2023" }
