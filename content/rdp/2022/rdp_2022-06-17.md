...
<https://makina-corpus.com/application-web-mobile/nocode-lowcode-makina-corpus-locokit> et <https://locokit.io/index.html>
...
Dans le cadres des financements qu'a reçu la société [Lutra Consulting](https://www.lutraconsulting.co.uk/) de la part de la communauté QGIS, elle communique régulièrement via son blog sur les améliorations associées à l'exploitation des données Lidar. Le moins que l'on puisse dire c'est qu'on est con est comme des gosses à chaque annonce d'amélioration liée au nuage de points ou à QGIS 3D! 
...
Tu t'intéresses aux infrastructures de données spatiales (IDS), un webinaire (EN) de présentation de GeoNode 4.0 organisé par [GeoSolutions](https://www.geosolutionsgroup.com) se tiendra le 30 Juin 2022. Pour participer à l'évènement, vous devez vous [inscrire via la page dédiée](https://www.geosolutionsgroup.com/blog/geonode-4-webinar/) et pour les simples curieux qui ne souhaitent pas participer, [une instance de démontration est aussi accessible](https://master.demo.geonode.org/).
