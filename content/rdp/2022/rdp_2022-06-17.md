...
Pour l'instant, le développement de cet outil réalisé par [A. Pavie](https://pavie.info) a été rendu possible grâce au financement de [GéoVélo](https://geovelo.fr) et [Carto Cité](https://cartocite.fr).
...
Tu t'intéresses aux infrastructures de données spatiales (IDS), un webinaire (EN) de présentation de GeoNode 4.0 (en développement) est organisé par [GeoSolutions](https://www.geosolutionsgroup.com) et se tiendra le 30 Juin 2022. Pour participer à l'évènement, vous devez vous [inscrire via la page dédiée](https://www.geosolutionsgroup.com/blog/geonode-4-webinar/) et pour les simples curieux qui ne souhaitent pas participer, [une instance de démontration est accessible](https://master.demo.geonode.org/).
