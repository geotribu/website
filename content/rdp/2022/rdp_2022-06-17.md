...
Dans le cadres des financements qu'a reçu la société [Lutra Consulting](https://www.lutraconsulting.co.uk/) de la part de la communauté QGIS, elle communique régulièrement via son blog sur les améliorations associées à l'exploitation des données Lidar. Le moins que l'on puisse dire c'est qu'on est comme des gosses à chaque annonce d'amélioration liée au nuage de points ou à QGIS 3D!
