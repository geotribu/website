...
La communauté de développeur d'OpenDroneMap vient de sortir la [version 3.0.0 d'ODM](https://opendronemap.org/2022/11/get-ready-odm-3-0-is-here/). Pour cette mouture, l'accent a été mis sur l'amélioration de la qualité des données en sortie comme pour le MNS et l'orthophoto, la suppression de certains paramètres hérités et la résolution de problèmes présents de longue date ([consulter le journal des modifications](https://github.com/OpenDroneMap/ODM/releases/tag/v3.0.0)).

Pour vous rendre compte des améliorations, vous pouvez vous rendre sur [cette page](https://opendronemap.github.io/UAVArena/) qui vous permet de comparer visuellement les résultats en sortie en fonction des applications/versions.
...
Le 21 novembre, France Culture a mis une nouvelle fois la carte en avant en acceuillant Christian Grataloup, auteur d'un "Atlas historique de la Terre", et Erik Orsenna, qui publie "La Terre a soif".
