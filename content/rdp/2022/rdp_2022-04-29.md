...
Nouvelle vidéo aussi ludique qu'instructive du [Capitaine Moustache](https://peertube.openstreetmap.fr/c/capitainemoustache_channel/videos) sur la contribution à OpenStreetMap. Cette fois-ci, il démontre comment faire de l'imagerie 360°, du Google Street View fait maison si vous voulez ! Puis, via Mapillary, on voit comment cette imagerie est très util pour la contribution à OpenStreetMap.
