...
Bref, la [version 9](https://github.com/OSGeo/PROJ/releases/tag/9.0.0) est sortie avec des mises à jour de la base de données (ça va ravir les gens qui installent QGIS via l'OSGeo4W avc les ~500 Mo à 17 ko/seconde :laughing:), de nouvelles options et un nettoyage sur les méthodes de compilation (CMake au profit d'Autotools).
