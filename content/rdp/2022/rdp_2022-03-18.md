...
description: "Dans la GeoRDP : des jolis globes, des modèles d'élévation artistiques, un nouveau format géospatial compatible Parquet (Hadoop), QGIS dans le navigateur, le set d'icônes Maki repackagé, une lib Python pour faire de jolies cartes facilement, etc."
...
La quinzaine qui s'achève a été intense pour le GéoTipi. Deux beaux articles liés à l'écosystème de QGIS, des échangs intéressants dans les commentaires (habituellement moribonds), le nettoyage de vieilles revues de presse par Mathieu (par exemple [celle ci qui fêtes ses 11 ans aujourd'hui exactement](https://static.geotribu.fr/rdp/2011/rdp_2011-03-18/) !) et des contributions externes pour cette revue de presse. Vous voilà bien gâté/es de toutes ces géonews diverses et variées !
...
Mais ne boudons pas notre plaisir, cette pre-release permet de se rendre compte que les développeur/ses n'ont pas chômé dans l'intervalle tant la liste des changements est longue. On retiendra que cette prochaine version va impliquer des ruptures dans l'API et que le nettoyage du code augure d'une nouvelle dynamique pour ce qui a d'abord été l'alternative légère à OpenLayers !
...
Bref, la [version 9](https://github.com/OSGeo/PROJ/releases/tag/9.0.0) est sortie avec des mises à jour de la base de données (ça va ravir les gens qui installent QGIS via l'OSGeo4W avc les ~500 Mo à 17 ko/seconde :laughing:), des options permettant et un nettoyage sur les méthodes de compilation.
...
[![prettymaps - Macao](https://github.com/marceloprates/prettymaps/raw/main/prints/macao.png "prettymaps - Macao"){: .img-center loading=lazy }](https://github.com/marceloprates/prettymaps/raw/main/prints/macao.png "prettymaps - Macao"){: data-mediabox="gallery-lightbox" data-title="prettymaps - Macao" }

[![prettymaps - Heerhugowaard](https://github.com/marceloprates/prettymaps/raw/main/prints/heerhugowaard.png "prettymaps - Heerhugowaard"){: .img-center loading=lazy }](https://github.com/marceloprates/prettymaps/raw/main/prints/heerhugowaard.png "prettymaps - Heerhugowaard"){: data-mediabox="gallery-lightbox" data-title="prettymaps - Heerhugowaard" }
...
François de Blomac et l'AFIGéo ont précisé le thème des prochains GéoDataDays (septembre 2022) et lancé [l'appel à interventions](https://www.afigeo.asso.fr/prenez-la-parole-aux-geodatadays-les-14-et-15-septembre-2022/).
