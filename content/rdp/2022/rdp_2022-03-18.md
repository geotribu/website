...
[GeoParquet](https://github.com/opengeospatial/geoparquet/), un nouveau projet porté l'[OGC](https://www.ogc.org) qui vient d'ouvrir un répertoire dédié pour :

- définir et normaliser la façon dont les données géospatiales seront représentées dans [Apache Parquet](https://parquet.apache.org)
...
On ne vous a encore jamais parlé du travail de [Julia Forte](https://www.juliaforteglobes.com) et pourtant cette artiste et fabriquante de globes basées à Londres propose une gamme de globes représentant la Londres sur 250 ans. Ces globes sont produits suivant des techniques traditionnelles des XVIIe et XVIIIe siècles et sont conçus pour être tenu en mains pour inviter son spectateur au voyage.
