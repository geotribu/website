...
[GeoParquet](https://github.com/opengeospatial/geoparquet/), ce nom ne vous dit peut-être rien, il s'agit d'un nouveau projet porté l'[OGC](https://www.ogc.org) qui vise à :
...
> Apache Parquet est un format de stockage en colonnes disponible pour tout projet de l'écosystème [Hadoop](https://hadoop.apache.org), quel que soit le choix du cadre de traitement des données, du modèle de données ou du langage de programmation.
