...
[GeoParquet](https://github.com/opengeospatial/geoparquet/), cela ne vous parle peut être pas et ce n'est pas surprenant car l'[OGC](https://www.ogc.org) vient d'ouvrir un répertoire dédié au projet afin de :

- normaliser la façon dont les données géospatiales seront représentées dans [Apache Parquet](https://parquet.apache.org)
