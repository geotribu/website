...
[![Elizabeth II](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/Elizabeth_II.jpg "Elizabeth II"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/Elizabeth_II.jpg){: data-mediabox="lightbox-gallery" data-title="Elizabeth II" }
...
Avec discrétion du fait de la période estivale, une préfiguration du futur de la Géoplateforme a été déployée : les services de géocodage Bêta 2.0.

Services au pluriel ? Oui car ces derniers s'adressent à plusieurs référentiels (adresse avec la Base Adresse Nationale (BAN), les Points d'intérêts (POI) et les parcelles), au travers de plusieurs services (géocodage direct, géocodage inverse et autocomplétion - en cours de peaufinage).

A noter que l'API mise en œuvre converge avec celle d'Etalab pour ce qui est des appels et des réponses. Surtout, elle ne se limite pas au référentiel adresse. D'ailleurs, la principale nouveauté de cette préfiguration est l'utilisation de la BAN comme référentiel adresse.

A suivre, le déploiement de ces services sur la Géoplateforme et le géocodage en masse. Une fois déployés sur l'infrastructure cible, la bêta disparaitra et de tels services pourront être rendus sur ses propres données.
...
[![SotM 2022, Photo de groupe](https://upload.wikimedia.org/wikipedia/commons/thumb/a/ae/State_of_the_Map_2022_-_group_photo_06.jpg/800px-State_of_the_Map_2022_-_group_photo_06.jpg "SotM 2022 - Photo de groupe"){: .img-center loading=lazy }](https://upload.wikimedia.org/wikipedia/commons/thumb/a/ae/State_of_the_Map_2022_-_group_photo_06.jpg/800px-State_of_the_Map_2022_-_group_photo_06.jpg){: data-mediabox="lightbox-gallery" data-title="SotM 2022, photo de groupe. Crédit : Photo by Carlo Prevosti, Wikimedia Italia, CC BY-SA 4.0"}
...
:warning: [D'après des échanges Twitter, il est conseillé de désactiver votre bloquer de pub pour vous inscrire.](https://twitter.com/mael_reboux_ig/status/1567485909607612418)
...
[![Inkarnate Isica](https://cdn.geotribu.fr/img/articles-blog-rdp/inkarnate_isica.webp "Exemple de carte réalisée avec Inkarnate")](https://cdn.geotribu.fr/img/articles-blog-rdp/inkarnate_isica.webp){: data-mediabox="lightbox-gallery" data-title="Exemple de carte réalisée avec Inkarnate" }
