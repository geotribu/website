...
- l’intégration avec [QFieldCloud BETA](https://qfield.cloud) qui vous permettra de synchroniser vos données.
...
![logo ShadeMap](https://cdn.geotribu.fr/img/internal/icons-rdp-news/ancien.png "logo ShadeMap"){: .img-rdp-news-thumb }
