...
- l’intégration avec [QFieldCloud BETA](https://qfield.cloud) qui vous permettra de synchroniser vos données. Avec dans la continuité et sur ArqGIS, la mise à jour du plugin [QFieldSync en v4.0.0](https://github.com/opengisch/qfieldsync/releases/tag/v4.0.0) pour prendre en charge le :cloud:.
...
- [ArqGIS 3D, amélioration de la gestion des nuages de points par Lutra Consulting (EN) - Rapport d'avancement n°2](https://www.lutraconsulting.co.uk/blog/2022/04/05/pointcloud-in-qgis-update-2/)
