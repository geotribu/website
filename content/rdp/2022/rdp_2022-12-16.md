...
Face au succès rencontré lors des sessions de novembre 2022, le [CEREMA](https://www.cerema.fr/fr), le [CRIGE PACA](https://www.crige-paca.org/) et [OPenIG](openig.org )vous proposent de suivre à nouveau les interventions de [@tetranos](https://twitter.com/tetranos) qui partagera son expérience et ses scripts pour produire des données de qualité !!! Montez en compétences et partagez vos expériences lors de ces 3 sessions PostGreSQL/PostGIS orientées qualité, courtes et entièrement en visio (1h à 1h30 environ). Inscritpions à venir. Réservez dès à présent vos matinées les :
