...
Inspiré par le logo « made with QGIS » de [Klas Karlsson](https://twitter.com/klaskarlsson), [Heikki Vesanto](https://twitter.com/heikkivesanto) propose sur son blog [plusieurs versions adaptées aux données OpenStreetMap](https://gisforthought.com/made-with-openstreetmap/) que vous pouvez intégrer dans vos cartes pour faire la promotion du projet.
