...
![logo Panoramax](https://cdn.geotribu.fr/img/logos-icones/entreprises_association/panormax.png "logo Panoramax"){: .img-rdp-news-thumb }
...
Pour contribuer c'est simple, vous devez créer un compte et [suivre les recommandations de la page dédiée](https://panoramax.ign.fr/partager-des-photos). En cas de problème, vous êtes invités à venir échanger sur le [forum des GéoCommuns]
...
[Rejoindre la communauté d’utilisateurs Lidar HD :fontawesome-brands-webhook:](https://geoservices.ign.fr/rejoindre-la-communaute-lidar-hd){: .md-button }
{: align=middle }
