...
- Nicolas David nous régale d'une trilogie d'articles sur les données Copernicus et Sentinel avec les deux premiers volets déjà publiés :
    - [données OCS et Sentinel](../../articles/2023-02-21_portails-copernicus-1-donnees.md)
    - [portails d'accès aux données Sentinel, 'the road so far'](../../articles/2023-02-28_portails-copernicus-2-passe.md)
