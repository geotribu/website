...
Alors que [QGIS 3.30 est sorti il y a 15 jours](/rdp/2023/rdp_2023-03-03/#qgis-330), [Lutra Consulting revient sur les nouvelles fonctionnalités 3D intégrées](https://www.lutraconsulting.co.uk/blog/2023/03/07/pointcloud-qgis-cf3-update1/) à cette version :
...
![logo CRIGE PACA](https://cdn.geotribu.fr/img/logos-icones/entreprises_association/crige_paca.jpg "logo CRIGE PACA"){: .img-rdp-news-thumb loading=lazy }
...
1. L’intro, par nos cogérantes Virginie Jourdan et Carole Arnaud
2. Les nouveautés de PostgreSQL 15, par Arnaud Bruniquel et Alain Lesage (Dalibo)
3. Retour d’expérience sur une migration d’Oracle à PostgreSQL, par Cédric Champmartin (Université de Lorraine)
4. PGTracer : eBPF pour tracer PostgreSQL, par Ronan Dunklau (Aiven)
5. Un éléphant pour 50 000 étudiants dans une université, par Nicolas Berne (Université Lyon 2)
6. PostgreSQL et ses cibles de restauration, par Stefan Fercot (EnterpriseDB)
7. Postgres Performance Observability Sources and Analysis Techniques, par Melanie Plageman (Microsoft)
8. PGaaS : PostgreSQL en tant que service, par Nicolas Gollet (Dalibo)
