...
comments: true
date: 2023-03-17
description: Geotribu lance un appel à volontaires pour continuer à vous parler de ArqGIS, de PostgreSQL, du LiDAR, d'OpenStreetMap,...
...
- Julien Moura a concocté un profil contenant tous les plugins et configurations au programme des [Rencontres des utilisateurs francophones de ArqGIS](https://conf.qgis.osgeo.fr/ "Site officiel de l'événement") et un scénario compatible avec [ArqGIS Deployment Toolbelt](https://guts.github.io/qgis-deployment-cli/ "Documentation de QDT (en anglais)") pour le déployer facilement sur sa machine, au clic ou via la ligne de commande. Voir [le tutoriel](../../articles/2023/2023-03-12_conference-qgis-fr-2023-profil-qdt-qgis-deployment-toolbelt.md "Déployer un profil ArqGIS avec ArqGIS Deployment Toolbelt").
...
Le plugin ArqGIS fait également l'objet d'améliorations comme la prévisualisation des graphiques, l'activation du fond de carte [OpenTopoMap](https://opentopomap.org/),...
...
### Fonctionnalités et améliorations 3D dans ArqGIS 3.30

![logo ArqGIS](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/qgis.png "logo ArqGIS"){: .img-thumbnail-left }

Alors que [ArqGIS 3.30 est sorti il y a 15 jours](rdp_2023-03-03.md#qgis-330), [Lutra Consulting revient sur les nouvelles fonctionnalités 3D intégrées](https://www.lutraconsulting.co.uk/blog/2023/03/07/pointcloud-qgis-cf3-update1/) à cette version :
...
![ArqGIS-Profil](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/qgis/qgis_pc3_update1_profile.png){: .img-center loading=lazy }
...
- [GéoInformations -  Espace interministériel de l’information géographique - un package ArqGIS 3.28 LTR proposé pour test](https://www.geoinformations.developpement-durable.gouv.fr/package-qgis-3-28-ltr-a3806.html)
...
- [ArqGIS 3.30 ‘s-Hertogenbosch (EN)](https://blog.qgis.org/2023/03/07/qgis-3-30-s-hertogenbosch-is-released/)
- [ArqGIS - Comment incorporer des modèles 3D dans une scène 3D à l'aide de ArqGIS2threejs (EN)](https://opengislab.com/blog/2023/3/11/how-to-incorporate-3d-models-into-qgis-to-create-a-3d-scene)
