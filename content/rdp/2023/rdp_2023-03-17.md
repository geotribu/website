...
- Julien Moura a concocté un profil contenant tous les plugins et configurations au programme des Rencontres des utilisateurs francophones de QGIS et un scénario compatible avec QGIS Deployment Toolbelt pour le déployer facilement sur sa machine, au clic ou via la ligne de commande. Voir [le tutoriel](/articles/2023/2023-03-12_conference-qgis-fr-2023-profil-qdt-qgis-deployment-toolbelt/ "Déployer un profil QGIS avec QGIS Deployment Toolbelt").
