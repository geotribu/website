...
- :book: Julien vous présente [le site PyQGIS Icons Cheatsheet qui liste les icônes intégrées à QGIS](../../articles/2023-03-24_pyqgis-icones-cheatsheet-automatisation.md) pour pouvoir les réutiliser facilement dans vos plugins
- :camera_with_flash: :world_map: Florian vous propose une solution pour [reconstituer des images aériennes historiques à partir d'OpenDroneMap et des images IGN de Remonter le temps](../../articles/2023-03-22_images_aeriennes_historiques.md).
- :white_check_mark: Delphine Montagne publie un [article superbement illustré sur son travail solidaire et bénévole au service de la validation des données dans le cadre de **H**umanitarian **O**penStreetMap **T**eam](../../articles/2023-03-27_validation-data-HOT-OSM.md).
