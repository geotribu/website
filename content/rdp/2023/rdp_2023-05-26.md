...
Plus de 500 commits, et près d'un an de préparation c'est ce qu'il aura fallu à l'équipe de contributeur pour annoncer la [version 3 de MapLibre GL JS](https://maplibre.org/news/2023-05-23-maplibre-gl-js-v3/). Parmi les changements notables :
...
Impressionés par le rendu, certains se sont prêtés à un cross-over du podium de la hyper tech 2023 : chatGPT + Unreal + tuiles 3D photoréalistes ! Et comme on disait du temps de [la mêlée géomatique d'Auch](https://www.ladepeche.fr/article/2011/11/19/1219002-auch-capitale-de-la-geomatique.html) : ça envoie du pâté !
