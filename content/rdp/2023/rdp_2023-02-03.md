...
!!! info "Contribution externe"
    ...
    Gab-OPenIG est chargé de projets à OPenIG, plateforme associative pour l'information géographique en Occitanie. Depuis 4 ans, OPenIG accompagne les montages de partenariats PCRS en donnant le meilleur possible à ses adhérents entre campagnes de vols IGN, appels de fonds Feder, suivi des recommandations nationales (CNIG, IGN, et maintenant ANCT) et conventionnement avec les gestionnnaires de réseaux (dont tout particulièrement les Territoires d'Energie et Enedis).  
