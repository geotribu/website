...
description: "Le #MapFailbruary est lancé, que ce soit en chanson ou en carte n’oubliez pas de partager vos carto-fails."
...
On vous propose de démarrer cette revue de presse en douceur avec une chanson sur la projection de Mercator à la manière de Britney Spears proposée par [ChatGPT](https://chat.openai.com) :woman_tone1:.
...
[desCartes](https://github.com/docuracy/desCartes) est un projet en développement lancé  par [Stephen Gadd](@docuracy) pour détecter le réseau routier sur d’anciennes cartes numérisées. Codé en Python, ce projet s’appuie sur divers librairies pour identifier et créer des lignes vectorielles du réseau qui peuvent être exploitées dans nos applications SIG pour analyser le maillage routier historique.
...
Alors le #MapFailbruary est votre nouveau hashtag à suivre !
