...
Un [livre de Edzer Pebesma et Roger Bivand vient de paraitre avec pour titre "La science des données spatiales - Des applications avec R"](https://r-spatial.org/book/). De quoi intéresser nos lectrices et lecteurs "R centré(e)s" !
