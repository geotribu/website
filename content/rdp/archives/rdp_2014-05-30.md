...
Pour finir, si vous souhaitez apprendre à utiliser CartoDB, jetez un coup d'[oeil par ici](http://blog.cartodb.com/post/87184734674/learn-cartodb-for-free-in-ny-hosted-by-gilt?utm_content=bufferbadf3&utm_medium=social&utm_source=twitter.com&utm_campaign=buffer), ça devrait fortement vous intéresser !



<iframe src="http://cartodb.github.io/showcase-maps/nightofmuseums/" frameborder="0" width="100%" height="720"></iframe>
...
<iframe style="border: 1px solid #CCC; border-width: 1px 1px 0; margin-bottom: 5px; max-width: 100%;" src="http://www.slideshare.net/slideshow/embed_code/35113059" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="427" height="356"> </iframe>
...
1- [Des perfomances nettement améliorées](https://twitter.com/qgis/status/468586740655996928) sur le rendu, affichage plus rapide et plus réactive


2- [Une option](http://nyalldawson.net/2014/05/colour-blindness-and-grayscale-previews-in-qgis-2-4/?utm_source=rss&utm_medium=rss&utm_campaign=colour-blindness-and-grayscale-previews-in-qgis-2-4) permettant d'adapter vos créations cartographiques aux daltoniens. Par ailleurs, je vous invite à regarder les travaux de [Francis Dhée](http://www.theses.fr/2013PA010556) sur l'amélioration de la carte topographique pour les daltoniens


3- La calculatrice de champ évolue vers [une meilleure intégration](http://nathanw.net/2014/05/23/qgis-field-calc-bar/) dans l'interface


4- Une meilleure gestion des styles (copier/coller un style) ou encore une [gestion des styles](http://nathanw.net/2014/03/12/qgis-qlr/) comme les .lyr d'Arcgis.


Et encore pleins de petites nouveautés, vous permettant de créer des [cartes toujours plus stylisées](http://blog.najackson.com/2014/05/more-designing-tips-for-vintage-maps-in-qgis/) !
...
Bon okay, après ce billet je vais certainement avoir droit à la palme du jeu de mots le plus pourri ! Restons sérieux et présentons un projet qui a le potentiel de bousculer notre future appréhension des adresses à savoir le [projet Bano](wiki.openstreetmap.org/wiki/WikiProject_France/WikiProject_Base_Adresses_Nationale_Ouverte_(BANO)). Initié par l'association [OpenStreetMap France](http://openstreetmap.fr), Bano est l'acronyme de Base Adresses Nationale Ouverte. Pour simplifier, ces différentes sources de données compatibles avec la licence OSM ont été agrégées afin de former [une couche homogène](tile.openstreetmap.fr/~cquest/leaflet/bano.html#19/45.75637/3.08666). Cette couche, offre aux contributeurs français une source supplémentaire d'information pour améliorer la précision d'OSM. L'objectif est pour le moment de compléter au maximum le nom de rues, ce qui permettra par la suite d'effectuer un processus automatique d'attribution d'adresse. Bon, je ne vous en dis pas plus, car le mieux est toujours de lire le [billet paru sur le site d'OSM-fr](http://openstreetmap.fr/blogs/cquest/bano-banco).
...
<iframe style="border: 1px solid #CCC; border-width: 1px 1px 0; margin-bottom: 5px; max-width: 100%;" src="http://www.slideshare.net/slideshow/embed_code/35002353" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="427" height="356"> </iframe>
...
RT [@globemakers](https://twitter.com/globemakers) Only in Japan [#globeburger](https://twitter.com/search?q=%23globeburger&src=hash) [#globes](https://twitter.com/search?q=%23globes&src=hash) [#worldglobe](https://twitter.com/search?q=%23worldglobe&src=hash) [#hamburger](https://twitter.com/search?q=%23hamburger&src=hash) [#cartography](https://twitter.com/search?q=%23cartography&src=hash) photo by [@jSteelemodel](https://twitter.com/jSteelemodel) [pic.twitter.com/BaYXXNpaNs](http://t.co/BaYXXNpaNs)
