...
[#3D](https://twitter.com/search?q=%233D&src=hash) model of Switzerland with the great [@QGIS](https://twitter.com/qgis) plugin [#QGIS2threejs](https://twitter.com/search?q=%23QGIS2threejs&src=hash) and [#SRTM](https://twitter.com/search?q=%23SRTM&src=hash) data <http://t.co/DCBNE4BV1K> [#WebGL](https://twitter.com/search?q=%23WebGL&src=hash) [pic.twitter.com/PegSwiCBJw](http://t.co/PegSwiCBJw)





Si vous souhaitez comprendre comment cela fonctionne et par la même occasion découvrir les reliefs escarpés de l'ile de la Réunion, je vous propose de consulter [cette vidéo](http://vimeo.com/83511028) réalisée par Michael Douchin :



<iframe src="//player.vimeo.com/video/83511028" frameborder="0" width="500" height="280"></iframe>
...
Pour être juste avec les autres structures, nous vous invitons également à consulter [l'annuaire OSGeo-fr](http://wiki.osgeo.org/wiki/Offres_Formations_fr) des prestataires sur les formations SIG opensource mais aussi les autres sociétés proposant des services liés aux SIG avec les géo-entreprises en passant au choix par [le site de l'AFIGEO](http://geo-entreprises.afigeo.asso.fr) (Association Française pour l'Information GEOgraphique) ou par [le site de GeoRezo](http://georezo.net/geo-entreprise/).
...
<iframe src="http://www.franceculture.fr/player/export-reecouter?content=4772390" frameborder="0" scrolling="no" width="481" height="139"></iframe>
