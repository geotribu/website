...
Si vous êtes un fidèle utilisateur du [plugin Geotagphotos](http://hub.qgis.org/projects/geotagphotos/wiki), vous serez heureux d'apprendre que celui-ci est désormais compatible avec la future version majeure (2.0) de [QGIS](http://www.qgis.org/). Pour rappel, ce plugin vous permet d'afficher et gérer des photos directement dans QGIS.
...
<iframe src="http://video.esri.com/iframe/2470/000000/width/480/0/00:00:00" frameborder="0" scrolling="no" width="480" height="270"></iframe>
...
Vous connaissez [ThisIsColossal](http://www.thisiscolossal.com/) ? Un blog sur ... euh ... un peu de tout sur les représentations digitales, les photos, l'architecture, le design, les performances artistiques :) Un peu comme [Fubiz](http://www.fubiz.net/).
