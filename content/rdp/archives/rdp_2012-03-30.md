...
### Mapping Party à Montpellier**  
 ...
 Rappelons brièvement le principe d'une Mapping Party qui consiste à se regrouper afin de cartographier collaborativement une zone définie. Les informations produites seront ensuite intégrées à la base de données libre [OpenStreetMap](http://www.openstreetmap.org/).
