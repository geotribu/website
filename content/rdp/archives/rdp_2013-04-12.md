...
C'est une belle revue de presse que nous vous offrons cette semaine. D'ailleurs, je tiens à remercier les différents contributeurs1 sans qui vous n'auriez pas votre bol de news hebdomadaire. Bon revenons à notre sujet principal. Au menu, vous aurez droit à la sortie de la [V2 de Monteverdi](#news11) et de la nouvelle [version de LizMap](#news11). Basculons ensuite sur OpenStreetMap avec cette superbe [réalisation 3D](#news21) ou encore la version française de [Learn OSM](#news22). Profitons en également pour prendre des nouvelles d'[OpenLayers 3 ](#news32), et n’hésitez pas à jeter un oeil aux applications [l'apparition du Nord](#news31) et [Animalerte](#news33). Une large section dédiée aux infographies est également disponible avec notamment cette [superbe animation](newsmat1) représentant la distance terre -> Mars ou encore [celle-ci](#newsmat2) représentant distance reste du monde -> Coree du nord. Enfin ne ratez pas la sortie du [programme de la conference Frog 2013](#news42) ainsi que cette [série d’œuvres](#news43) de l’artiste David Thomas Smith basée sur Google Maps.
...
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/oxDW_z5kMQ0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
