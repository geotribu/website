...
Un brin bravache, Kipling Crossing argue que le poids de GDAL, la complexité de son installation (il doit pas avoir lu nos tutos [ici](/articles/2013/art_2013-09-26/) et [là](../../articles/2020/2020-10-28_gdal_windows_subsystem_linux_wsl.md) :wink:) et les instabilités liées aux bindings Python devraient suffire à faire réfléchir avant de l'utiliser systématiquement.
