...
[![map snap halloween 2021](https://cdn.geotribu.fr/img/articles-blog-rdp/map_snap_halloween_2021.jpeg "Map snap Halloween 2021 from @RagerBrian_"){: loading=lazy width=300px }](https://cdn.geotribu.fr/img/articles-blog-rdp/map_snap_halloween_2021.jpeg){: data-mediabox="lightbox-gallery" data-title="Map snap Halloween 2021 from @RagerBrian_" }
{: align=middle }
...
- :mailbox_with_mail: [Retour de la newsletter](/newsletter/signup/). Abonnez-vous pour être certain/e de ne manquer aucun de nos contenus !
...
[![QField 1.10](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/QField/qfield_move_duplicate.webp "QField 1.10"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/QField/qfield_move_duplicate.webp){: data-mediabox="lightbox-gallery" data-title="QField 1.10" }
...
[![carte carburants](https://cdn.geotribu.fr/img/articles-blog-rdp/carburant.png "Carte des carburants"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/carburant.png){: data-mediabox="lightbox-gallery" data-title="Carte des carburants" }
...
![icône Wikipedia](https://cdn.geotribu.fr/img/logos-icones/divers/wikipedia.png "Logo Wikipedia"){: .img-rdp-news-thumb }
...
[![france hype](https://cdn.geotribu.fr/img/articles-blog-rdp/france_hype.png "La France hype"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/france_hype.png){: data-mediabox="lightbox-gallery" data-title="La France hype" }
...
Pour ceux à qui ça ne parle pas, vous pouvez aller sur [le repo Github officiel](https://github.com/tjukanovt/30DayMapChallenge) ou vous rendre à [la GeoRDP de l'année dernière](/rdp/2020/rdp_2020-11-13/#representation-cartographique) :wink:
...
![Logo dynartio](https://cdn.geotribu.fr/img/logos-icones/entreprises_association/dynartio_logo.png "logo dynartI/O"){: .img-rdp-news-thumb }

Comme on adore travailler sur [les thématiques autour de la mobilité douce](/articles/2021/2021-04-07_carte_reseau_bus/), quand on trouve des articles sympas chez les collègues, pourquoi se priver de leur lecture !
...
[![voies cyclables angouleme](https://cdn.geotribu.fr/img/articles-blog-rdp/CarteVeloAngoulemeV7A-1.png "Voies cyclables Angoulême"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/CarteVeloAngoulemeV7A-1.png){: data-mediabox="lightbox-gallery" data-title="Voies cyclables Angoulême" }
...
![logo_geodatalab_crige](https://cdn.geotribu.fr/img/logos-icones/divers/crige_geodatalab.png "Logo Géodatalab du CRIGE"){: .img-rdp-news-thumb }
...
[![crige paca cerema banner_quality](https://cdn.geotribu.fr/img/articles-blog-rdp/divers/crige_paca_cerema_banniere_qualite.png "CRIGE PACA CEREMA Bannière qualité"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/divers/crige_paca_cerema_banniere_qualite.png){: data-mediabox="lightbox-gallery" data-title="CRIGE PACA CEREMA Bannière qualité" }
...
![logo FOSS4G_2021](https://cdn.geotribu.fr/img/logos-icones/divers/FOSS4G_2021.png "FOSS4G_2021"){: .img-rdp-news-thumb }
