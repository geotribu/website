...
comments: true
date: 2021-10-22
description: 'GeoRDP du 22 octobre 2021 : On vous emmène cette semaine à la découverte des dernières actualités de la géomatix. ArqGIS 3.22, QompliGIS, Input, R, deep fakes, carte des trains, cartogrammes, etc.'
...
![icône QompliGIS](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/qompligis.png "icône QompliArqGIS"){: .img-thumbnail-left }

[QompliGIS](https://gitlab.com/Oslandia/qgis/qompligis), un nouveau plugin ArqGIS développé pour contrôler la conformité des plans de récolement (DAO ou SIG) en s’appuyant sur :
...
![ArqGIS 3.22 - Mesh edition expression](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/qgis/qgis_3-22_mesh_edition_expression_demo.gif "ArqGIS 3.22 - Mesh edition expression"){: .img-center loading=lazy }
...
![ArqGIS 3.22 - Annotations](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/qgis/qgis_3-22_annotations_demo.gif "ArqGIS 3.22 - Annotations"){: .img-center loading=lazy }
