...
tags: rdp,QGIS,QSoccer,OpenStreetMap,IGN,Occupation du sol,Géo-communs,réseaux,QGIS,Lyon,cartographie,PGSession14,PostreSQL
---
...
[![La place des Jacobins dans Lyon en 1700](https://cdn.geotribu.fr/img/articles-blog-rdp/divers/lyon1700jacobins.jpg "La place des Jacobins dans Lyon en 1700"){: loading=lazy width=325px }](https://cdn.geotribu.fr/img/articles-blog-rdp/divers/lyon1700jacobins.jpg){: data-mediabox="demo-lightbox" data-title="La place des Jacobins dans Lyon en 1700" }
[![La porte du Pont du Rhône](https://cdn.geotribu.fr/img/articles-blog-rdp/divers/lyon1700porterhone.jpg "La porte du Pont du Rhône"){ loading=lazy width="325px" }](https://cdn.geotribu.fr/img/articles-blog-rdp/divers/lyon1700porterhone.jpg){: data-mediabox="demo-lightbox" data-title="La porte du Pont du Rhône" }
{: align=middle }
...
[![Agence ORE - Carte des réseaux](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/agence_ore_reseaux.png "Logo PGsession14"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/agence_ore_reseaux.png){: data-mediabox="lightbox-gallery" data-title="Agence ORE - Carte des réseaux" }
...
![Démo de QSoccer](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/qsoccer_demo.gif " Démo QSoccer"){: .img-center loading=lazy }

### La carte papier à l’IGN - Pétition

![icône IGN](https://cdn.geotribu.fr/img/logos-icones/entreprises_association/ign.png "IGN"){: .img-rdp-news-thumb }

Alors que les français retrouvent un intérêt pour les sorties en pleine nature et qu’ils redécouvrent la France provoquant une augmentation des ventes de cartes papiers, l’IGN semble tout de même décidé à arrêter les activités de son imprimerie et le savoir faire qui va avec au profit de sous-traitant. Si vous souhaitez vous engager dans la défense de l’imprimerie de l’IGN, la [CGT vient de lancer une pétition](https://cgtgeo.wordpress.com/2021/06/25/communique-de-presse-des-syndicats-cgt-de-lign-du-25-juin-2021/) sur [change.org](https://www.change.org/p/directeur-général-de-l-ign-institut-national-de-l-information-géographique-et-forestière-non-à-l-arrêt-de-la-carte-papier-à-l-ign).
