...
![Logo QSoccer](){: .img-rdp-news-thumb }

Après la présentation de [QasketBall](https://www.youtube.com/watch?v=HlLlJz9sghk) :basketball:  lors du [QGIS Open Day](https://github.com/qgis/QGIS/wiki/QOD-June-2021) de juin 2021, Oslandia a sorti une première version d'un plugin permettant de voir des données de matchs de football dans QGIS : QSoccer :soccer: ! Cette première version permet de récupérer des données en Open Data mises à disposition par [StatsBomb](https://github.com/statsbomb/open-data), et de les afficher dans un widget en utilisant notamment les bibliothèques Open Source [kloppy](https://kloppy.pysport.org/) et [mplsoccer](https://mplsoccer.readthedocs.io/en/latest/). Pour plus de détails, vous pouvez consulter l'article [ici](https://oslandia.com/2021/06/25/qsoccer-qgis-football-what-else/).

Ces deux projets prouvent que même le sport a toute sa place dans les SIG !

![Démo de QSoccer](https://user-images.githubusercontent.com/8960009/124078097-04534a80-da48-11eb-9844-206dd9314537.gif)
