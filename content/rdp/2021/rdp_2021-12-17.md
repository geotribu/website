...
Nous ne vous en avions pas parlé dans nos précédentes revues de presse mais fin Novembre avait lieu les [journées des utilisateurs d’OTB](https://www.orfeo-toolbox.org/otb-user-days-2021-plenary-talks-workshops-and-more/) au [Fablab Artilect de Toulouse](https://artilect.fr). Au menu de ces journées, des ateliers, un hackfest et des conférences que vous pouvez revoir ci-dessous (en français).
