...
Déjà présentée lors d'une précédente [#geordp](https://static.geotribu.fr/rdp/2020/rdp_2020-12-25/#inkmap-la-nouvelle-bibliotheque-pour-imprimer-vos-cartes-web), la librairie d'impression cliente [Inkmap](https://github.com/camptocamp/inkmap) propose sa première Release 1.0.0.
La release est disponible sous forme de [paquet npm](https://www.npmjs.com/package/@camptocamp/inkmap) vous permettant de l'intégrer facilement dans votre application frontend javascript.

Cette sortie s'accompagne d'un [site de démonstration](https://camptocamp.github.io/inkmap/master/) en ligne illustrant des cas d'usages et donnant les bonnes pratiques d'utilisation de la librairie:

- gestion de file d'impression
- projections personalisées
- gestion d'erreur
- export PDF ...

Parmis les nouvelles fonctionnalités, on retrouve les possibilités d'impressions raster (XYZ, WMS, WMTS) et vecteur (WFS) basée sur le format de style [Geostyler](https://github.com/geostyler/geostyler-style).
La possibilité d'utiliser des projections personnalisées et d'ajouter en overlay les attributions, l'échelle ou encore la flèche nord.
