...
### Un _package_ R pour la détection de motifs spatiaux
[icône motif](https://nowosad.github.io/post/motif-bp6/figs/logo.png "Logo packages motif"){: .img-rdp-news-thumb }


Cette semaine, je suis tombé sur [un post de blog](https://nowosad.github.io/post/motif-bp6/) super de [@jakub_nowosad](https://twitter.com/jakub_nowosad). On a ici une belle synthèse en 5 parties de l'usage du package [motif](https://cran.r-project.org/web/packages/motif/index.html) qu’il développe et maintien.
...
Si vous manipulez régulièrement des restés, et que vous chercher a décrit des modèles spatiaux pour toute espace régulière ou irrégulière définie. Jakub Nowosad nous prend par la main pour nous expliquer comment construire des métriques qui décrivent quantitativement "des signatures" spéciales en se basant sur des matrices de cooccurrence. Ce package permet d'effectuer des analyses spatiales telles que la recherche, la détection des changements et le regroupement sur des modèles spatiaux (si vous êtes intéressé par la publi : [Nowosad (2021)](https://link.springer.com/article/10.1007%2Fs10980-020-01135-0)).
...
* que des développements complémentaires et des améliorations successives viendront s’ajouter en 2023 et 2024
