...
Si vous manipulez régulièrement des restés et que vous cherchez à décrire des modèles spatiaux pour tout espace régulier ou irrégulier défini, Jakub Nowosad nous prend par la main pour nous expliquer comment construire des métriques qui décrivent quantitativement "des signatures" spéciales en se basant sur des matrices de co-occurrence.  
