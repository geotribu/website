...
Prévu pour s'intégrer à [geOrchestra](https://www.georchestra.org/fr/), la solution continue d'évoluer tranquillement mais sûrement, avec deux versions correctives ce mois-ci après une version importante en fin d'année dernière.
