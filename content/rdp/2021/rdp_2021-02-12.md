...
- Tutoriel Python sur la manière de [générer une page de prévisualisation des icônes intégrées à ArqGIS](../../articles/2021/2021-02-02_pyqgis_previsualiser_images_integrees.md)
...
[Inputapp 0.8.0](https://inputapp.io/fr/) est sorti avec plusieurs nouvelles fonctionnalités dont la plus importante est la possibilité de créer un nouveau projet ArqGIS avec des colonnes personnalisables (checkbox, datetime, photo, number et text) directement depuis son smartphone/tablette dans l'application. Cela permet d'improviser une mission carto directement sur le terrain avec un stockage des données au format GeoPackage ; de retour au bureau il n'y a plus qu'à brancher son appareil en USB sur l'ordinateur et ouvrir son projet ArqGIS !
