...
[Inputapp 0.8.0](https://inputapp.io/fr/) est sorti avec plusieurs nouvelles fonctionnalités, la plus importante est la possibilité de créer un nouveau projet Qgis avec des couches personnalisables directement depuis son smartphone/tablette dans l'application. Cela permet d'improviser une mission carto directement sur le terrain avec un stockage des données au format géopackage, de retour au bureau il n'y a plus qu'à brancher son appareil en USB sur l'ordinateur et ouvrir son projet Qgis!
