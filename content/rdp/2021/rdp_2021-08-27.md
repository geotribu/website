...
### Un portail Open Data basé sur OSM pour l'Italie

Un [nouveau portail Open Data](https://italia.geo.sm/) s'appuyant sur les données OpenStreetMap est disponible depuis peu en Italie. Ce portail se base sur la [plateforme GeOsm](https://github.com/GeOsmFamily) développé initialement au Cameroun  par l'association [OSM Cameroun](http://openstreetmap.cm/). En 2019, cette plateforme avait également été adaptée à la France sous le nom de [OSM Data](https://demo.openstreetmap.fr/map).

![geosm italia](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/geosm_italia.png)
...
### Trouvez l'inspiration pour votre prochaine flêche du nord

La plupart du temps nous ajoutons à nos mises en page cartographiques la flèche du nord proposé par défaut par notre logiciel SIG. Pourtant, cet élément anodin peut se révéler être une véritable oeuvre d'art qui habillera vos cartes. Pour trouver l'inspiration, n'hésitez pas à consulter cette [page Pinterest](https://www.pinterest.fr/plansreliefs/roses-de-vents-cartes-anciennes-wind-roses-ancient/) qui en liste un grand nombre.

![rose des vents](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/rose_des_vents.png)

----

## En bref

- hebdoOSM [576](https://weeklyosm.eu/fr/archives/14762), [577](https://weeklyosm.eu/fr/archives/14782)
...
- [QGIS - Le plugin Cadastre se met à jour et prend notamment en charge les fichiers MAJIC 2021](https://docs.3liz.org/QgisCadastrePlugin/changelog/)
