...
Peut-être que cet été vous avez décidé de fuir les plages bondés de la côte d'Azur et d'aller en montage pour vous adonner à la randonnée ?

Si jamais vous avez eu une discussion autour du nom du pic se situant devan vous, alors [PeakFinder](https://www.peakfinder.org/?lat=45.9925&lng=7.5817&ele=3566&off=2019&azi=357.15&alt=14.69&fov=110&cfg=s&name=) a la solution !
...
Site internet et application mobile, c'est un véritable scruteur de monts que Fabio Soldati nous propose. Vou spourrez même voler de sommet en sommet, grâce à la fonctionnalité de survol.

Le design est très épuré et efficace, et l'application fournit directement l'information sur le nom des sommets situés devant vous, ce qui concluera la discussion en cours de rando.
