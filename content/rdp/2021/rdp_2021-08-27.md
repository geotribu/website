...
- [Ireland](http://ireland.geo.sm)
- [Colombie](http://colombia.geo.sm)
- ...
...
tilemaker est une application qui s’installe sur un ordinateur du bureau ou sur un serveur et qui permet de créer facilement des tuiles vectorielles à partir des données OpenStreetMap, elle passe en [version 2.0](https://github.com/systemed/tilemaker/releases) et s’accompagne d’[un site tout neuf](https://tilemaker.org) pour promouvoir cet outil de création de tuiles vectorielles. Nous n’avons pas testé mais n’hésitez pas à revenir vers nous si vous souhaitez présenter l’outil à travers un article :wink:.
