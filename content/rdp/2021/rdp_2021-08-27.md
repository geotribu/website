...
license: default
tags: "rdp,jeu video, IGNMap, Google, Afrique, globe, arduino, DIY, cartographie, Android, Maps.me, Organic Maps, geogame, devinettes, pokemon, incendie, tuiles vectorielles"
---
...
Les personnes impliquées de longue date dans la plateforme n'ont pas manqué de réagir, sceptiques par rapport à la justification et dénonçant un manque de volonté politique, à l'instar de Jérôme Desboeufs (fondateur de [Living Data](https://www.livingdata.fr/), l'entreprise derrière l'essentiel des développements) :
