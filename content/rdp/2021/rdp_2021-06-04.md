...
tags: rdp,lego,OpenStreetMap,cartographie,OSGeo Live,PostGIS,Android,pgRouting
---
...
[P. Ramsey](http://blog.cleverelephant.ca/about) se souvient très bien de cette époque et revient sur [la génèse de PostGIS à travers un article](http://blog.cleverelephant.ca/2021/05/postgis-20-years.html) où il explique que cette première version ajoutait :
...
Et que [PostGIS](http://postgis.net) s’est rapidement imposé comme une brique essentielle de l’écosystème geospatial open source en étant rapidement pris en charge par des applications tel que [GDAL](https://gdal.org), [MapServer](https://mapserver.org) ou encore GeoTools/[GeoServer](http://geoserver.org).
