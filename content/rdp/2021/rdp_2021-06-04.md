...
- :floppy_disk: du côté des coulisses, on a remis au propre [la section A propos](/team/) et décrit le [mécanisme de sauvegarde]({{ config.extra.url_contribuer }}internal/backup/) du site Geotribu
