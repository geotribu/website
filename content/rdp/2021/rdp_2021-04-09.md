...
Le web regorge de tutoriels sur QGIS. Cette semaine, je souhaite partager avec vous deux ressources qui vallent le détour.
La première est une [ressource itialienne déposée sur Github](https://gist.github.com/pigreco/f1705597c3515c21d81c64df1b46db09) par [Totò Fiandaca](https://pigrecoinfinito.com/) sur les fonctions spatiales avancées dans QGIS. Si vous êtes adpetes des formulaires QGIS et ses options de mise à jour automatique, cette ressource ne manquera pas de vous intéresser.
