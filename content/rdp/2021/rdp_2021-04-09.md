...
### Nuit de la Géographie 2021

![icône nuit](https://cdn.geotribu.fr/img/internal/icons-rdp-news/night.png "Nuit"){: .img-rdp-news-thumb }

Ce vendredi 9 avril 2021 se tiendra la Nuit de la Géographie. Evènement mondial organisé par l'Union géographique internationale, il s'appuie sur des associations locales pour préparer notamment des tables rondes et mapathons.

Vous trouverez [la carte des évènements organisées à cette occasion ici](https://www.geonight.net/geonight-2021-events-map/) (étrangement réalisée via Google My Maps :confused:).

![geonight 2021](https://cdn.geotribu.fr/img/articles-blog-rdp/cropped-GeoNight-blu.png "GéoNight 2021"){: loading=lazy .img-center }
