...
### SE METTRE A POSTGRES/POSTGIS

![icône news générique](https://cdn.geotribu.fr/img/internal/icons-rdp-news/news.png "News"){: .img-rdp-news-thumb }

Lors de la session de [géovisioconférence des Reflus aux Confins du 16 mars](https://www.twitch.tv/videos/960265215), Michaël Gallien invitait les géomaticiens à utilisez le couple posgres/postgis pour réaliser des géotraitements. Si vous doutez encore de la puissance de ce SGBD spatial, prenez une heure et laisser vous convaincre par les différentes démonstrations réalisées.  
