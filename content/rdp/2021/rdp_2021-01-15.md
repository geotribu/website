...
Folium est le chainon manquant entre Javascript et Python pour utiliser Leaflet dans le deuxième susnommé.  
...
Vous avez sans doute déjà entendu parler de [kepler.gl](https://kepler.gl/), [deck.gl](https://deck.gl/) ou [H3](https://h3geo.org/). Ces outils ont en point commun d'avoir été développé par les mêmes personnes, travaillant à l'origine dans l'équipe Visualisation d'Uber.  
...
Peu de doute que nous n'en entendions pas parler sous peu :smile: !
