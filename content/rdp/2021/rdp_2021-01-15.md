...
Vous avez sans doute déjà entendu parler de kepler.gl, deck.gl ou [H3](https://h3geo.org/). Ces outils ont en point commun d'avoir été développé par les mêmes personnes, travaillant à l'origine dans l'équipe Visualisation d'Uber.  
Ils permettent d'afficher des données géographiques grâce aux dernières technologies web.

Cette semaine, la même équipe (qui a depuis créé la société Unfolded.ai en 2019) vient [d'annoncer le lancement d'Unfolded Studio](https://www.unfolded.ai/blog/2021-01-12-introducing-studio/).  
Ils parlent de ce nouvel outil web comme la nouvelle génération des plateformes d'analyses et de visualisation géospatiales. Tout un programme !
...
Vous trouverez, en cliquant sur l'image ci-dessous, un exemple de ce à quoi ça peut ressembler.
...
Si vous souhaitez vous y essayez, allez faire un tour ici https://studio.unfolded.ai/home, il existe un free tier pour tester la bête.
...
Nous n'allons pas vous parler ici de tennis ou de rugby, mais bien des Bases Adresses Locales (BAL).  
