...
tags: rdp,pgmodeler,openlayers,trex,folium,rtkbase,unfolded,projections,openardennemap,terre mediane,github,erosion,changement climatique,youtube,tutoriel,opendata,c215, industrie spatiale, adresse
---
...
[Folium](https://python-visualization.github.io/folium/) est le chainon manquant entre Javascript et Python pour utiliser Leaflet dans le deuxième susnommé.  
Vous manipulez vos données grâce à Python et vous pouvez les visualiser avec les principes de Leaflet.js, toujours via Python, grâce à Folium.
...
Vous avez sans doute déjà entendu parler de [kepler.gl](https://kepler.gl/), [deck.gl](https://deck.gl/) ou [H3](https://h3geo.org/). Ces outils ont en point commun d'avoir été développés par les mêmes personnes, travaillant à l'origine dans l'équipe Visualisation d'Uber.  
Ils permettent d'afficher des données géographiques grâce aux dernières technologies web.

Cette semaine, la même équipe (qui a depuis créé la société [Unfolded.ai](https://www.unfolded.ai/) en 2019) vient [d'annoncer le lancement d'Unfolded Studio](https://www.unfolded.ai/blog/2021-01-12-introducing-studio/).  
Ils le présentent comme la nouvelle génération des plateformes d'analyses et de visualisation géospatiales. Tout un programme !
...
Clairement dit comme ça, ça donne envie !  
Vous trouverez, en cliquant sur l'image ci-dessous, un exemple de ce à quoi ça peut ressembler :point_down:
...
* l’impression de 2mx70cm qu’il a réalisée
...
La représentation est interactive et chaque élément affiché est cliquable.

Ils ont [publié récemment deux posts](https://github.blog/2020-12-21-how-we-built-the-github-globe/) sur le [blog Github](https://github.blog/)
...
La newsroom américaine ProPublica.org vient de publier [un article sur l'érosion des plages hawaïennes.](https://projects.propublica.org/hawaii-beach-loss/)  
L'article expose notamment la manière dont les digues construites par les propriétaires privés accentuent le phénomène.
...
Il en a réalisés 4 pour l'instant, notamment sur [JOSM (un des éditeurs OSM)](https://www.youtube.com/watch?v=rwLtFXrAJQM) ou encore sur le portail OSM Data, dont [nous vous avions déjà parlé ici !](/rdp/2020/rdp_2020-11-13/#openstreetmap-osm-data)
...
Nous n'allons pas vous parler ici de tennis, de basket ou de rugby (enfin bref, vous avez la galéjade :wink:), mais bien des Bases Adresses Locales (BAL).  
Il s'agit des adresses officiellement reconnues par les instances compétentes localement, et qui remontent dans la Base Adresse Nationale.
...
[Un modèle de données BAL est produit par l'AITF](https://aitf-sig-topo.github.io/voies-adresses/files/AITF_SIG_Topo_Format_Base_Adresse_Locale_v1.2.pdf) et le projet est notamment piloté par Etalab qui a créé un outil de gestion de BAL : mes-adresses.data.gouv.fr.
