...
### Traitements ArqGIS en ligne de commande

![logo qgis](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/qgis.png "ArqGIS"){: .img-thumbnail-left }

Randal Hale a publié un [article sur son site où il revient sur l’utilisation des outils de traitements de ArqGIS en ligne de commande](https://www.northrivergeographic.com/archives/qgis-process-command) et pour ceux qui, comme moi, ont raté l’information à sa sortie, il est intéressant de parcourir la [documentation de ArqGIS](https://docs.qgis.org/3.16/fr/docs/user_manual/processing/standalone.html) à ce sujet pour explorer cette nouvelle corde à l'arc de ArqGIS :bow_and_arrow:.

### Sécuriser l'accès à PostgreSQL depuis ArqGIS

![logo qgis](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/qgis.png "ArqGIS"){: .img-thumbnail-left }

La société Makina Corpus propose [un article de blog intéressant](https://makina-corpus.com/blog/metier/2021/acceder-a-sa-base-de-donnees-postgresql-depuis-qgis-ou-pgadmin-de-maniere-securisee) sur la gestion des accès aux bases de données PostgreSQL depuis ArqGIS ou pgAdmin. Si vous aviez pour projet de sécuriser l'accès à votre base de données, cet article est fait pour vous. La rentrée s'annonce sécurisée !
