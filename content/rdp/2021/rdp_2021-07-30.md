...
license: default
tags: rdp,QGIS,inondation,3D,Géoplateforme,Géoservices,CNIG,Occupation du sol,PCRS,PostgreSQL,IGN,France Inter
---
...
L’équipe participant à la course de relais de l’actualité lève légèrement le pied durant cette période estivale mais vous propose tout de même cette revue de presse Juillet :sunglasses:.

Bonne lecture :books: et bonnes vacances à ceux qui ne sont pas encore partis :beach_umbrella:!
...
La société Makina Corpus propose [un article de blog intéressant](https://makina-corpus.com/blog/metier/2021/acceder-a-sa-base-de-donnees-postgresql-depuis-qgis-ou-pgadmin-de-maniere-securisee) sur la gestion des accès au base de données PostgreSQL depuis QGIS ou pgAdmin. Si vous aviez pour projet de sécuriser l'accès à votre base de données, cet article est fait pour vous. La rentrée s'annonce sécurisée !
...
<!-- markdownlint-disable MD033 -->
<iframe src="https://www.franceinter.fr/embed/player/aod/20d6704d-a414-44e8-a442-e5a354179ab1" width="100%" height="100%" layout="responsive" frameborder="0" scrolling="no"></iframe>
<!-- markdownlint-enable MD033 -->
...
Il y a eu de nombreuses nouveautés ces derniers mois du côté du producteur national de données géographiques (ouverture des données, nouveau DGS, géoplateforme, etc.) Dans ce contexte, l'ancien site des Géoservices, bien connu de tous les professionnels de la géomatique, a été relooké de la tête au pied. Ce [nouveau site des Géoservices](https://geoservices.ign.fr/) proposé par l'IGN est très bonne nouvelle pour les géomaticiens. L'offre semble beaucoup lisible. Il s'agit d'ailleurs l'un des deux objectifs fixés avec ce nouveau site, premièrement simplifier l’accès à l’offre de données et services destinée aux professionnels et deuxièmement développer les interactions avec les communautés d’usages professionnelles. Bonne découverte !
