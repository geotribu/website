...
En décembre 2020, [Tim Sutton](https://twitter.com/timlinux) a donné accès [à un projet démonstrateur d'un plugin QGIS](https://plugins.qgis.org/geopackages/5/) permettant de créer des dashboards.

Depuis, [Luis Perez](https://twitter.com/Luiseperezg) a continué à travailler dessus. [_Nous vous en parlions notamment ici_](rdp/2021/rdp_2021-01-29/#des-tableaux-de-bords-cartographiques-avec-qgis)
...
Une campagne de financement participatif vient d'être lancé par QGIS Panama. Cette campagne a pour objectif d'avancer sur le développement du plugin, en proposant une interface conviviale et un ensemble de fonctionnalités, dont  vous trouverez [le descriptif ici](https://www.nosolosig.com/noticias/1214-campana-de-crowdfunding-del-complemento-qgis-dashboard).
