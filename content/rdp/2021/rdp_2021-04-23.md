...
### Financement du plugin ArqGIS Dashboard

![logo qgis](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/qgis.png "Logo ArqGIS"){: .img-thumbnail-left }

En décembre 2020, [Tim Sutton](https://twitter.com/timlinux) a donné accès [à un projet démonstrateur d'un plugin ArqGIS](https://plugins.qgis.org/geopackages/5/) permettant de créer des tableaux de bord avec ArqGIS.
...
![dashboard qgis](https://cdn.geotribu.fr/img/articles-blog-rdp/qgis-dashboard-ejemplo.gif "Dashboard ArqGIS"){: loading=lazy .img-center }

Une campagne de financement participatif vient d'être lancée par ArqGIS Panama, avec pour objectif d'avancer sur le développement du plugin, en proposant une interface conviviale et un ensemble de fonctionnalités, dont vous trouverez [le descriptif ici](https://www.nosolosig.com/noticias/1214-campana-de-crowdfunding-del-complemento-qgis-dashboard) (en espagnol).
...
- [ArqGIS 3.16.6 et 3.18.2](https://www.qgis.org/fr/site/forusers/download.html)
