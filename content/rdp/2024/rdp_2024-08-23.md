...
![logo GRASS](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/grass.png "logo Grass"){: .img-thumbnail-left loading=lazy }

Avec plus de 520 changements, la nouvelle version, majeure, 8.4.0 de GRASS GIS apporte sont lot de modifications, dont :
...
![Logo AroundUs](https://cdn.geotribu.fr/tinyfilemanager.php?p=logos-icones%2Fentreprises_association&view=AroundUs.webp "Logo AroundUs"){: .img-thumbnail-left }

Les voilà, enfin, les temps attendues vacances, cette année ce sera 4 semaines de congès...c'est le minimum pour déconnecter.
...
Le principe est finalement assez simple, un fond ortho et des photos-bulles sur les points d'intérêts qui se trouvent tout autour de vous.
Un clic sur une bulle, et hop, une synthèse automatisée des articles Wikipédia concernant le POI vous est proposé.
![AroundUs version Web](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/Site_AroundUs.PNG){: .img-center loading=lazy }

AroundUs existe [en version Web](https://fr.aroundus.com/) mais si vous souhaitez l'avoir dans la poche vous pouvez aussi opter pour l'App disponible sur [Android](https://play.google.com/store/apps/details?id=com.digsty.aroundus&hl=fr) et [Apple](https://apps.apple.com/cm/app/around-us-tr%C3%A9sors-cach%C3%A9s/id6448239731).
...
![Pratique du Rugby en France](https://substackcdn.com/image/fetch/w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3bb3d033-f730-4b48-a8e5-5724dcd429fc_2295x2291.png){: .img-center loading=lazy }
...
![Écran du démonstrateur LiDAR HD sur Paris](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/LiDAR_hd_paris.webp){: .img-center loading=lazy }
