...
:bullettrain_side: Tigaligalam pam palam ! Le train de la GeoRDP entre en gare ! C'est l'heure de partir en vacances, après des dernières semaines bien agitées et angoissantes en France. Quelques wagons à la suite aujourd'hui dans le train, et venez en voiture 14 découvrir les géospécialités offertes par les Baristas du wagon restaurant.

![Ecran carte "Voyagez, autrement." de cartes.app](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/carte_trains_europe.png){: .img-center loading=lazy }
...
[Map Map](https://store.steampowered.com/app/2702260/Map_Map__A_Game_About_Maps/) est un jeu vidéo qui sortira bientôt sur Steam (date non annocée encore), au travers duquel il s'agit "d'embarquer dans une chasse au trésor en tant que cartographe d'un équipage d'aventure, et en utilisant votre sens de l'orientation pour créer des cartes, aider vos compagnons et explorer des îles idylliques". Découvert via [ce podcast GeoMob](https://thegeomob.com/podcast/episode-240).
