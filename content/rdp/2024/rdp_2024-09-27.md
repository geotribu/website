...
- :sun_with_face: Après pas moins de 9 articles, la série d'été de [Loïc](../../team/loic-bartoletti.md) pour mieux comprendre comment les calculs géométriques sont gérés dans nos logiciels SIG est arrivée à son terme hier. Une fin en beauté avec un numéro spécial "Bien-être géomatique & LifeStyle" pour vivre une vie géométriquement saine, faite de calme topologique et volupté à virgule flottante.
...
C'est le pavé qu'Even Rouault (développeur principal de GDAL et PROJ) a lancé dans la mare cette semaine et qui donne à réfléchir. Et vous, quelle relation avez-vous avec ce format :
