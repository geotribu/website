...
### Grass en version 6.4.2
 ...
 [Grass](http://grass.fbk.eu/) est l'un des logiciels SIG OpenSource les plus anciens mais aussi l'un des plus puissants. A titre d'exemple, au-delà du logiciel lui-même il est utilisé en tant que boite à outils dans [QGIS](http://www.qgis.org/) ou comme base de services WPS dans [PyWPS](https://pywps.org/). Depuis peu, [une nouvelle version (6.4.2)](http://grass.osgeo.org/announces/announce_grass642.html) est disponible. En terme de nouvelles fonctionnalités signalons l'ajout ou la correction de 770 mises à jour du code, une interface graphique encore améliorée et surtout le support total du langage python.
