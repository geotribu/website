...
### Suivi en temps réel des modifications**  
 Quelle est l'activité (ajouts/suppressions/modification) de la base [OpenStreetMap](http://www.openstreetmap.org/) en ce moment même ? Vous aurez très certainement beaucoup de mal à me répondre n'est-ce pas ? En fait, le plus simple est de consulter cette [application de monitoring](http://openstreetmap.us/live/) qui analyse l'activité OSM en temps réel. En vert, ce sont les créations d'objets, en jaune les modifications et en rouge les suppressions. Plutôt sympa non ? A quand un widget à placer sur mon bureau Ubuntu ?.
