...
En ces temps de Jeux Olympiques, nous en avons pour les amateurs de toutes les disciplines. Commençons par le côté client avec la sortie de la version 0.4 de Leaflet ou l'apparition d'un Geo CMS, MapIgniter. L'épreuve Datavisualisation est composée entre autres d'une jolie carte de l'internet et d'une animation sympa sur l'historique et l'actualité des J.O. Enfin, avant de finir en sprint par les news diverses, faites un détour par la section OpenData où l'on parle de la libération de données par la RATP et de la plate-forme de géocodage CSVMap. Et si le coeur vous en dit, faites un don à ForumSIG, une plate-forme dopée...à sa communauté !
...
![logo MapIgniter](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/mapigniter.png "logo MapIgniter"){: .img-thumbnail-left }
...
![logo internetmap](https://cdn.geotribu.fr/img/logos-icones/divers/internetmap.png "logo internetmap"){: .img-thumbnail-left }
...
![logo WeDoData](https://cdn.geotribu.fr/img/logos-icones/entreprises_association/webodata.png "logo WeDoData"){: .img-thumbnail-left }
...
![logo 3G](https://cdn.geotribu.fr/img/logos-icones/divers/3G.png "logo 3G"){: .img-thumbnail-left }
...
![logo RATP](https://cdn.geotribu.fr/img/logos-icones/entreprises_association/ratp.png "logo RATP"){: .img-thumbnail-left }
...
> Via [memoclic](http://www.memoclic.com/841-lego/16580-google-lego-3d.html)
