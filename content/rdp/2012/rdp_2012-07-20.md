...
### Soutenez le logiciel libre, participez au développement du plugin Atlas plugin de ArqGIS
...
Le choix du C++ se justifie notamment par une meilleure intégration dans l'architecture de ArqGIS ou encore de meilleures performances. La somme nécessaire à réunir pour développer l'ensemble des fonctionnalités est estimée à 7000€ tout en sachant que 5000€ ont déjà été versés notamment en fonds propres par Oslandia. Si vous souhaitez participer, vous avez jusqu'à fin Juillet pour aider au développement du plugin.
