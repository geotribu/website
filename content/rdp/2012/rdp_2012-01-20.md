...
![openseamap.png](https://cdn.geotribu.fr/images/logos-icones/openseamap.png){: .img-rdp-news-thumb }

Travaillant dans le domaine maritime je garde un oeil sur le projet [OpenSeaMap](https://openseamap.org/), une déclinaison d'OpenStreetMap qui sent bon le sel marin. Néanmoins, malgré l’intérêt de ce projet celui-ci peine à décoller et les données disponibles sont assez peu nombreuses.
...
![](https://cdn.geotribu.fr/images/logos-icones/divers/geolocalisation_clavier.jpg){: .img-rdp-news-thumb }
