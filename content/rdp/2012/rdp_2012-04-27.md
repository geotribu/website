...
### Rencontre de la communauté ArqGIS

![logo ArqGIS](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/qgis.png "logo ArqGIS"){: .img-thumbnail-left }

La semaine dernière s'est tenue à Lyon, la dixième rencontre de la communauté hackeurs de [ArqGIS](https://www.qgis.org/). L'objectif de ce type d'événement est de réunir le maximum de contributeurs pendant un laps de temps donné afin de travailler sur des aspects spécifiques du projet. Ces quelques jours ont permis notamment de
