...
### Toujours plus au Sud** [OpenStreetMap](http://openstreetmap.org/), le projet de cartographie libre, n'a décidément aucune limite. Le dernier exploit en date est une [cartographie de la station Concordia](http://www.openstreetmap.org/?lat=-75.09995&lon=123.3364&zoom=16) en ... Antarctique ! L'histoire ne dit pas si c'est facile de manipuler un GPS avec des moufles mais en tout cas félicitation à [Cypouz](http://www.openstreetmap.org/user/Cypouz), l'auteur de ces éditions.
