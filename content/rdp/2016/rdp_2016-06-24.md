...
[![pgRouting sous Windows](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/pgRouting.png "pgRouting sous Windows"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/OpenSolarMap.png){: data-mediabox="lightbox-gallery" data-title="pgRouting sous Windows" }
...
![icône inuit](https://cdn.geotribu.fr/img/logos-icones/divers/inuit-logo.png "icone inuit"){: .img-rdp-news-thumb }
