...
OpenStreetMap vient de franchir une nouvelle étape, celui du [milliard de noeuds](https://www.openstreetmap.org/browse/node/1000000000). Encore une preuve du formidable engagement de ces volontaires de l'information géographique ! Combien de noeuds faudra-t-il pour couvrir la terre entière ? Profitons-en pour signaler également la mise à disposition de l'orthophoto de Tours. Le mouvement Open Data continue à faire des émules ! Si vous souhaitez intégrer celle-ci à JOSM, suivez les [conseils](http://www.mail-archive.com/talk-fr@openstreetmap.org/msg28293.html) de François Van der Biest.

## Service

### Baidu

![Logo Baidu](https://cdn.geotribu.fr/img/logos-icones/entreprises_association/baidu.png "Logo Baidu"){: .img-thumbnail-left }
...
![Baidu Maps - place Tian anmen](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/reupload/baidu_map_web.png){: .img-center loading=lazy }
