...
### Carte au style aquarelle avec ArqGIS

![logo ArqGIS](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/qgis.png "logo ArqGIS"){: .img-thumbnail-left }

On ne vous présente plus [Anita Graser](https://anitagraser.com/about/), connue sous le pseudo d'Underdark mais surtout pour ces nombreux posts sur l'utilisation de ArqGIS. Elle est notamment l'auteure du dernier "learning ArqGIS". Début janvier, Anita nous proposait [un post](https://anitagraser.com/2015/01/04/how-to-watercolor-pastel-style-in-qgis/) sur la création de carte aquarelle (ressemblant fortement à celle de Stamen) avec le moteur de rendu de ArqGIS.

[![Aquarelle ArqGIS](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/carte_aquarelle.jpg "Aquarelle ArqGIS"){: .img-center loading=lazy }](https://anitagraser.com/2015/01/04/how-to-watercolor-pastel-style-in-qgis/)
