...
[![PostGIS Layer Viewer](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/postgis_layer_viewer.png "PostGIS Layer Viewer"){: loading=lazy width=300px }](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/postgis_layer_viewer.png){: data-mediabox="lightbox-gallery" data-title="PostGIS Layer Viewer" }
{: align=middle }
