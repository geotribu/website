...
Nous en avions [déjà parlé](http://geotribu.net/GeoRDP/20150123#Fermeture-annoncee-de-Google-Maps-Engine) la fin du mois de Janvier, mais avec la news sur Google Earth Pro il nous a paru intéressant de le rappeler. Google il y a peu avait également annoncé la fermeture de son service Google Maps Engine. Suite à cette surprenante décision, ma première pensée avait été que la firme travaillait probablement sur un nouveau service. Mais les récents événements me font plutôt craindre un désengagement du marché des SIG professionels.
...
Ben Wellington, passionné d'open-data s'est mis en tête suite à une discussion avec Brian Lehrer d'explorer le phénomène de [gentrification](http://fr.wikipedia.org/wiki/Gentrification "lien wikipedia vers la page anglaise") à New-york.
...
Si l'idée vous intéresse, vous pouvez allez jeter un oeil sur [le billet de blog de Ben](http://iquantny.tumblr.com/post/109370229799/does-gentrification-cause-a-reduction-in).


![](https://cdn.geotribu.fr/img/articles-blog-rdp/gentri.jpg)
...
- Des tooltips avec l'[outil de mesure](http://openlayers.org/en/master/examples/measure.html) OpenLayers 3
