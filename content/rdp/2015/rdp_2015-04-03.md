...
[![PAC-MAN](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/google_maps_pacman.gif "PAC-MAN"){: loading=lazy width=300px }](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/maptime.png){: data-mediabox="lightbox-gallery" data-title="PAC-MAN" }
{: align=middle }
