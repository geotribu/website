...
[![Simpsons - Heatmap](https://cdn.geotribu.fr/img/articles-blog-rdp/divers/simpsonsdotmap_rainbow2.png "Simpsons - Heatmap"){: loading=lazy width=300px }](http://cartonerd.blogspot.fr/2015/02/when-is-heat-map-not-heat-map.html)
{: align=middle }
...
![icône papillon](https://cdn.geotribu.fr/img/logos-icones/divers/papillon.png){: .img-rdp-news-thumb }
...
[![Papillon cartographique](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/butterfly-world-map.jpg "Papillon cartographique"){: loading=lazy width=300px }](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/butterfly-world-map.jpg){: data-mediabox="lightbox-gallery" data-title="Papillon cartographique" }
{: align=middle }
