...
[![ogr2layers plugin](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/ogr2layers.png "qgis2web plugin"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/ogr2layers.png){: data-mediabox="lightbox-gallery" data-title="ogr2layers plugin" }
