...
Il y a quelques temps, une campagne de financement avait été lancée afin d'ajouter des effets artistiques à vos couches. Et bien voila, depuis hier, [Nyall Dawson a publié dans ArqGIS 2.9](http://nyalldawson.net/2015/04/introducing-qgis-live-layer-effects/) cette fonctionnalité.
...
![ArqGIS - Effets](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/qgis-live-layer-effect-2.png "ArqGIS - Effets"){: .img-center loading=lazy }
