...
Après une [première présentation aux GéoDatadays 2018](https://www.geodatadays.fr/_medias/afigeo/files/presentation/Open_Data/GEODATADAYS_2018_OpenData_MOURA.pdf), le site était resté à l'état végétatif. Mon changement de situation professionnelle et le confinement ont eu raison de ma procrastination, je me suis donc remis à la tâche. Il reste encore beaucoup de travail (non, ne regardez pas le menu carte...) mais la mécanique globale est en place, même si c'en est pas fini des [problèmes d'encodage du RSS](https://georezo.net/extern.php?fid=10) !
