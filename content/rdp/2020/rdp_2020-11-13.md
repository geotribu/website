...
[![InfluxDB - Circles](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/influxdb_geo_circles.jpg "Carte du taux d'incidence"){: width=300 loading=lazy}](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/influxdb_geo_circles.jpg){: data-mediabox="lightbox-gallery" data-title="InfluxDB - Circles"}
[![InfluxDB - Heatmap](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/influxdb_geo_heatmap.jpg "Carte du taux d'incidence"){: width=300 loading=lazy}](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/influxdb_geo_heatmap.jpg){: data-mediabox="lightbox-gallery" data-title="InfluxDB - Heatmap"}
...
[![Thèmes 30daymapchallenge](https://cdn.geotribu.fr/img/articles-blog-rdp/30dmc.jpg "Thèmes 30daymapchallenge"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/30dmc.jpg){: data-mediabox="lightbox-gallery" data-title="Thèmes 30daymapchallenge"}
...
[![Mayors Dialogue on Growth and Solidarity](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/mayors_dialogue_visual_motif.png "Mayors Dialogue on Growth and Solidarity"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/mayors_dialogue_visual_motif.png){: data-mediabox="lightbox-gallery" data-title="Mayors Dialogue on Growth and Solidarity"}
...
[![Tous (im)mobiles, tous cartographes ?](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/tous_immobiles_tous_cartographes.png "Tous (im)mobiles, tous cartographes ?"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/tous_immobiles_tous_cartographes.png){: data-mediabox="lightbox-gallery" data-title="Tous (im)mobiles, tous cartographes ?"}
...
[![Strava - Heatmap](https://cdn.geotribu.fr/img/articles-blog-rdp/Strava_Global_Heatmap.png "Heatmap des activités Strava enregistrées"){: .img-center loading=lazy}](https://cdn.geotribu.fr/img/articles-blog-rdp/Strava_Global_Heatmap.png){: data-mediabox="lightbox-gallery" data-title="Strava - Heatmap"}
...
Pour faire suite au [tutoriel de prise en main d'Aerialod](/articles/2020/2020-09-20_tutorial_aerialod/) publié sur Geotribu le 14 octobre dernier, [Alasdair Rae](https://twitter.com/undertheraedar) vient de publier [un article concernant la création de cartes de densité de population](http://www.statsmapsnpix.com/2020/11/how-to-make-3d-population-density.html), où il explique son processus passant par QGIS et Aerialod, à partir de données de population.

[![Population alasdair rae](https://cdn.geotribu.fr/img/articles-blog-rdp/pop_aerialod.jpg "Densité de population avec Aerialod"){: .img-center loading=lazy}](https://cdn.geotribu.fr/img/articles-blog-rdp/pop_aerialod.jpg){: data-mediabox="lightbox-gallery" data-title="Densité de population avec Aerialod"}
