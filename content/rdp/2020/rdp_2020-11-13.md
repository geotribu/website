...
Le [site de partage de styles QGIS](https://plugins.qgis.org/styles/) vient juste d'être lancé avec pour but de faciliter l'échange de styles entre les utilisateurs. Dans la vidéo ci-dessous, Sumandari et Tim Sutton vous présentent cette nouvelle solution de partage qui pourrait bien devenir incontournable. A voir s'il mérite qu'on l'installe en plus de [QGIS Resource Sharing](https://qgis-contribution.github.io/QGIS-ResourceSharing/).
