...
authors: Arnaud Van de Casteel, Julien Moura, Mathieu Rajerison
Category: Revues de presse
Date: 2020-07-24 10:20
description: "Revue de presse géomatique du 24 juillet 2020 : API QGIS unifiée, carte de l'univers, néologismes, animation 3D avec R stats, GeoDataDays, Uber et Google Maps, valeur économique de l'information géographique."
hero: "Revue de presse du 24 juillet 2020"
Tags: rdp,R,QGIS,projection,geotools,geoserver,geodatadays,uber,google maps,argent
---
...
[Etienne Trimaille](https://twitter.com/etrimaille), développeur chez 3Liz et ancien contributeur dans nos colonnes, a trouvé une façon originale et très _méta_ d'illustrer l'intégration de la gestion de la dimension temporelle dans la dernière version stable de QGIS (3.14). Le petit projet permet de visualiser la feuille de route du logiciel en utilisant les dates de sortie des versions [publiées ici](https://www.qgis.org/fr/site/getinvolved/development/roadmap.html#release-schedule). Simple et efficace :
...
Découvert pendant le confinement avec leur outil de suivi en temps réel de l'épidémie [Kalisio Covid-19](https://github.com/kalisio/covid-19), focus sur l'application Akt'N Map de Kalisio. Elle est distrbuée en mode Saas et prête à l'emploi. Elle permet notamment une gestion facilitée de la création de membres et groupes, la création d'événements et de modèles types mais aussi de rendu statistique et d'historique.
...
<iframe width="560" height="315" src="https://youtu.be/T5Y2F4ZQsXg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
