...
Parmi toutes les réactions, j'ai personnellement été intéressé par [le billet de blog de Joe Morrisson](https://joemorrison.medium.com/death-of-an-open-source-business-model-62bc227a7e9b) (qui bosse chez [Azavea](https://www.azavea.com/), qui font notamment [loam](https://github.com/azavea/loam)) qui, au-delà du changement de licence, y voit la fin de l'un des modèles économiques de l'open source : [Open Core](https://fr.wikipedia.org/wiki/Open_core).
