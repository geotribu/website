...
tags: rdp,lizmap,geonode,qgis,openstreetmap,OrfeoToolBox,globes,opendronemap,30daymapchallenge,pycsw,owslib,opendata
---
...
![icône news générique](https://cdn.geotribu.fr/img/internal/icons-rdp-news/news.png "MapBoxGL"){: .img-rdp-news-thumb }

Après l'annonce de la mise à jour de MapBoxGL qui apporte des améliorations majeures, bon nombre d'utilisateurs on fait la grimace à la lecture de la première ligne du [changelog](https://github.com/mapbox/mapbox-gl-js/releases/tag/v2.0.0) qui annonçait un changement license :lock:.
