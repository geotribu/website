...
C'est la fin de l'année qui approche et cette semaine, on vous propose une bonne blague de géographe qu'on va vous jouer carte sur table..., qu'elle est le comble d'un géographe? (:black_joker: Réponse après avoir lu l'intégralité de la revue de presse)
