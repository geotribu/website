...
Serval est un plugin ArqGIS développé par [Lutra Consulting](https://www.lutraconsulting.co.uk/) qui permet l'édition de petites zones de raster via ArqGIS.

Il vient d'être mis à jour avec notamment :

- la possibilité d'effectuer une sélection grâce à plusieurs types d'outils
- la modification de rasters avec des expressions ArqGIS
...
- Sortie de [ArqGIS 3.16.2 et 3.10.13](https://www.qgis.org/fr/site/forusers/download.html)
