...
![Plotly](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/plotly.png){: .img-rdp-news-thumb }  
...
De quoi rajouter au débat sur la recomposition spatiale (ou pas :smiley:).
