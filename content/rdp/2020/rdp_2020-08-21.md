...
description: "Revue de presse géomatique du 21 août 2020 (#GeoRDP) : les visualisations de Craig Taylor, l'accès libre (mais caché !) aux orthophographies en haute résolution de l'IGN, le travail en cours sur une balise HTML map (Map4HTML ou MapML), une Google Car arrêtée par la gendarmerie française et la finalisation de la constellation de satellites chinois BeiDou."
hero: "Revue de presse du 21 août 2020"
tags: rdp, pysal, BeiDou, orthophotographies, haute résolution, IGN, Craig Taylor, Map4HTML, MapML
---
