...
[OpenStreetMap](http://www.openstreetmap.org/) continue son petit bonhomme de chemin en s'incrustant dans les plans de villes. Nous en avons parlé à plusieurs reprises, mais c'est toujours bon de se faire rafraichir un peu la mémoire. Merci [@JM\_Dubosc](https://twitter.com/JM_Dubosc) pou cette belle image.


Les trois plans de ville réalisés à partir des données [#openstreetmap](https://twitter.com/search?q=%23openstreetmap&src=hash) !! :-) [pic.twitter.com/IdZyfcr3df](http://t.co/IdZyfcr3df)
...
- Un [article](http://www.independent.co.uk/life-style/gadgets-and-tech/features/are-mapbox-and-openstreetmaps-personalised-maps-the-future-of-cartography-8675498.html) intéressant sur le futur de la cartographie personnalisée avec [MapBox](http://www.mapbox.com/) et [OpenStreetmap](http://www.openstreetmap.org/)
