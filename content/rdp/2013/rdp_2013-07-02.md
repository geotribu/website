...
Tandis que des systèmes de projection apparentent la Terre à une feuille plate, à un [coeur ](https://fr.wikipedia.org/wiki/Projection_de_Bonne)ou à une [peau d'orange](http://en.wikipedia.org/wiki/Goode_homolosine_projection), un système de projection la fait ressembler à un [origami](http://www.genekeyes.com/FULLER/BF-3-1944.html).
