...
A noter qu'il est possible de ventiler les valeurs des rectangles au sein de chaque carreau (cela rend les données plus fines mais pas forcément plus fiables). Aussi, l'INSEE propose-t-elle sur son site la méthode pour le logiciel propriétaire MapInfo mais aussi, surprise, [pour ArqGIS](http://www.insee.fr/fr/ppp/bases-de-donnees/donnees-detaillees/donnees-carroyees/mode-operatoire-qgis.pdf).
