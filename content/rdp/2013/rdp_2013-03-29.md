...
Le [bulletin n°15](http://openstreetmap.fr/bulletin-OSM-FR-15) des activités [d'OpenStreetMap](https://www.openstreetmap.org/) est en ligne :) C'est du lourd - 3 mois d'activités en une seule page. Bonne lecture, c'est toujours passionnant.
