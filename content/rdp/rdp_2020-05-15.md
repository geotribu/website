...
![logo Grass](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/grass-logo.png){: .img-rdp-news-thumb }
...
![logo GDAL](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/gdal_0.png){: .img-rdp-news-thumb }

L'infatigable [Even Rouault a annoncé](https://lists.osgeo.org/pipermail/gdal-dev/2020-May/052117.html) tout récemment la sortie de [GDAL](www.gdal.org) en version 3.1.0. Cette version apporte de nouveaux drivers GDAL (Cloud Optimized GeoTIF, OpenEXR), l'intégration du driver FlatGeoBuf dans OGR ainsi que différentes améliorations (support du GeoTIFF 1.1, lecture/création/mise à jour des extensions SHP .shz et .shp.zip).
