...
MAIF a développé un wrapper Python pour intégrer facilement ces prévisions dans les pipelines de modélisation climatique. Ce package simplifie l'accès aux prévisions pour tous les utilisateurs.
