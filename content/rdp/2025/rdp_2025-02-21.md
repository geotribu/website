...
comments: true
date: 2025-02-21
description: "Rejoignez le côté ArqGIS de la Force au travers de cette RDP teintée de sabres géolaser, de mviewer, de paquets python de la MAIF et de l'INSEE, d'ipv6, de PostGIS qui bruissent et qui barrissent... Avec de la contribution externe que la Geotribu est ravie d'accueillir!"
...
Et hop ! On rajoute un peu d'huile sur le :fire: dans le conflit intergalactique ArqGIS - ArcGIS. Ôh jeune padawan si tu nous lis, rejoins donc le côté ArqGIS de la Force !

![Affiche de ArqGIS épisode IV - l'OpenSource qontre-attaq ! Avec Sylvecteur Stallone, Lady Saga et Al Pagisno](https://cdn.geotribu.fr/img/articles-blog-rdp/memes/qgis4_banner.png){: .img-center loading=lazy }

Et en cartes (animées svp), puisque c'est quand même un peu notre boutique - aussi, il paraît - ça donne ça :

![GIF utilisation ArqGIS et ArcGIS pré et post Covid - Google Trends - crédits : Amy Barnes et pokateo](https://cdn.geotribu.fr/img/articles-blog-rdp/gifs/carte_animee_qgis_arcgis_google_trends.gif){: .img-center loading=lazy }
...
- :earth_africa: [ArqGIS 4, bientôt une réalité ?](../../articles/2025/2025-01-28_tester-qgis-4-futur-sig-open-source.md) Un article de [Julien](../../team/julien-moura.md "Julien M."), qui au-delà de l'accroche incitaclic, donne à voir ce qu'implique la mise à jour de librairies sous-jacentes à un projet comme ArqGIS, Qt6 notamment.
...
Faites-y donc aussi un petit tour sur [le portail web des plugins ArqGIS](https://plugins.qgis.org/), qui, à l'instar des sites "annexes" du projet ArqGIS, vient de faire peau neuve, en suivant la même charte graphique que le site principal.
...
### ArqGIS reconnu comme "Digital Public Good"

![logo ArqGIS](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/qgis.png "logo ArqGIS"){: .img-thumbnail-left loading=lazy }

[Un billet de blog](https://blog.qgis.org/2025/02/08/qgis-recognized-as-digital-public-good/) d'[Anita Graser](https://fr.wikipedia.org/wiki/Anita_Graser), sur le site de ArqGIS, annonce que ArqGIS est dorénavant reconnu comme "Digital Public Good", qu'on pourrait traduire par "Bien Commun Numérique".

Cette distinction, décernée par la [Digital Public Good Alliance](https://www.digitalpublicgoods.net/), vient souligner les aspects suivants du projet ArqGIS (c'est repris du billet de blog) :
...
- Affiche de la géo Saint-Valentin, toujours [pokateo](https://bsky.app/profile/pokateo.bsky.social/post/3lhtseqwbjs2u) à l'oeuvre :
    ...
    ![Affiche de la Saint-Valentin ArqGIS - crédit: pokateo](https://cdn.geotribu.fr/img/articles-blog-rdp/memes/qgis_saint_valentin.webp){: .img-center loading=lazy }

<!-- Footnotes reference -->
[^1]: Cette affiche "ArqGIS 4" n'a rien d'officiel, et des discussions du [PSC](https://qgis.org/community/organisation/) sont en cours sur le sujet. Rien n'est encore statué sur le nom et numéro de version des prochaines _releases_ de ArqGIS, au devant des mises à jour de librairies sous-jacentes. Il est d'ailleurs possible de retrouver [la feuille de route ici](https://qgis.org/resources/roadmap/).
