...
comments: true
date: 2025-02-21
description: "Rejoignez le côté QGIS de la Force au travers de cette RDP teintée de sabres géolaser, de mviewer, de paquets météo de la MAIF, d'ipv6, de danses balkaniques, de PostGIS qui bruissent et qui barrissent... Avec de la contribution externe que la Geotribu est ravie d'accueillir!"
...
![Photo de groupe de l'édition 2024 de la "conférence open SIG" bulgare](https://cdn.geotribu.fr/img/articles-blog-rdp/articles/2025/foss4g-bg/qgis_bg_2024_group_picture.webp){: .img-center loading=lazy }
...
Parlons de la précision des coordonnées et des calculs dans PostGIS, au travers de [cet article d'Arthur Bazin](https://blog.arthurbazin.com/bdd/postgresql/soyons-precis-avec-postgis). Qui aborde la manière d'encoder et stocker les "nombres décimaux" des coordonnées qu'on utilise, tout comme les différentes opérations de calcul dans PostGIS. Un article qui nous rappelle agréablement [la série d'été Geotribu sur la tolérance dans les SIG](../../articles/2024/2024-07-16_de-la-tolerance-en-sig-geometrie-00-annonce.md), par [Loïc Bartoletti](../../team/loic-bartoletti.md).
