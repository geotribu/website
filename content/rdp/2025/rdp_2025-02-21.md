...
- :dancer: Les Balkans bientôt dans Geotribu! Avec un billet de blog en cours sur le premier FOSS4G Bulgarie qui est en train de se monter, [sur `blog.geotribu.net`](https://blog.geotribu.net/), la déclinaison anglophone de Geotribu. À laquelle tout un chacun peut contribuer bien sûr, tout le monde est bienvenu, et peu importe le fuseau horaire. Le blog anglophone de Geotribu [est d'ailleurs référencé dans le feed de planet.qgis.org](https://planet.qgis.org/subscribers/geotribu_en/). Pour célébrer ça, voici la photo de groupe de l'année dernière:
...
De toutes façons, assez tardé dans cette intro qui tire décidément en longueur... Allez, c'est parti pour la RDP, bonne lecture!
