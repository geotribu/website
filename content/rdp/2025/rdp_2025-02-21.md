...
comments: true
date: 2025-02-21
description: "Rejoignez le côté QGIS de la Force au travers de cette RDP teintée de sabres laser, de mviewer, de paquets météo de la MAIF, d'ipv6, de danses balkaniques, de PostGIS qui bruissent et qui barrissent... Et cela écrit à plusieurs mains, avec de la contribution externe que la Geotribu est ravie d'accueillir!"
...
- :thumbsup: Dédicace à _Eric_ qui nous a tipé un peu d'argent récemment, sur [notre page Tipeee](https://fr.tipeee.com/geotribu). Qui sert à nous financer à différents niveaux (listés sur la page Tipeee), dans l'optique de rester indépendants également. Merci Rico!
...
- :dancer: Les Balkans bientôt dans Geotribu! Avec un billet de blog en cours sur le premier FOSS4G Bulgarie qui est en train de se monter, [sur `blog.geotribu.net`](https://blog.geotribu.net/), la déclinaison anglophone de Geotribu. À laquelle tout un chacun peut contribuer bien sûr, tout le monde est bienvenu, et peu importe le fuseau horaire. Le blog anglophone de Geotribu [est d'ailleurs référencé dans le feed de planet.qgis.org](https://planet.qgis.org/subscribers/geotribu_en/). Pour célébrer ça, voici [une musique de BG](https://youtu.be/zwT4TZlMba0?feature=shared), vraiment. Bon, désolé hein... C'est peut-être mieux d'annoncer cet heureux évènement avec la photo de groupe de l'année dernière:
...
Faites-y donc aussi un petit tour sur [plugins.qgis.org](https://plugins.qgis.org/), le portail web des plugins QGIS, qui vient de faire peau neuve.
...
[ipv6](https://fr.wikipedia.org/wiki/IPv6) est le nouveau protocole de dénomination des adresses IP, standardisé dans les années 90 pour prendre la suite d'[ipv4](https://fr.wikipedia.org/wiki/IPv4) et ses adresses IP codées sur 32 bits, ce qui en laisse que 4 milliards disponibles, un nombre faible comparé aux 128 bits d'ipv6 et les autres avantages induis par ce protocole.
...
![vignette logo PostGIS](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/postgis.png "vignette logo PostGIS"){: .img-thumbnail-left loading=lazy }

Parlons de la précision des coordonnées et des calculs dans PostGIS, au travers de [cet article d'Arthur Bazin](https://blog.arthurbazin.com/bdd/postgresql/soyons-precis-avec-postgis). Qui aborde la manière d'encoder et stocker les "nombres décimaux" des coordonnées qu'on utilise, tout comme les opérations de calcul de PostGIS. Un article qui nous rappelle [la série d'été Geotribu sur la tolérance dans les SIG](../../articles/2024/2024-07-16_de-la-tolerance-en-sig-geometrie-00-annonce.md) de Loïc Bartoletti.
...
- Affiche de la géo Saint-Valentin, par [pokateo](https://bsky.app/profile/pokateo.bsky.social/post/3lhtseqwbjs2u) toujours:
