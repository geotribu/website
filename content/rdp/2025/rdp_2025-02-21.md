...
Et en cartes (animées!), puisque c'est quand même un peu notre boutique - aussi, ça donne ça:
...
De toutes façons, assez tardé dans cette intro qui tire décidément en longueur... Allez, c'est parti pour la RDP, à fond les ballons :balloon: avec du [Goran Bregović](https://fr.wikipedia.org/wiki/Goran_Bregovi%C4%87)! Bonne lecture!

<iframe width="100%" height="400" src="https://www.youtube-nocookie.com/embed/qkwnkt8mwjU?si=7qWNyKjA_AS0a7bN" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
:icecream: [Super billet de blog de Paul Ramsey](https://blog.cleverelephant.ca/2025/02/wkb-empty.html), sur [`cleverelephant.ca`](https://blog.cleverelephant.ca/) qu'on vous conseille de marque-pager dans votre navigateur préféré (par exemple Internet Explorer v9) des fois que vous comprenâsses l'anglois. Un billet au long duquel il est possible de découvrir le [GeoIceberg](https://github.com/apache/iceberg/issues/10260), et qui aborde les subtilités du stockage des géométries vides dans les différents formats utilisant le [WKB](https://libgeos.org/specifications/wkb/).
