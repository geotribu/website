...
Aujourd'hui, ça commence par une bande-annonce au box-office :camera:, eh oui! Geotribu c'est du grand cinéma ;)
...
!!! warning "Attention"
    Cette affiche "QGIS 4" n'a rien d'officiel, et des discussions du [Project Steering Committee](https://qgis.org/community/organisation/) sont en cours sur le sujet. Rien n'est encore statué sur le nom des prochaines versions de QGIS au devant des mises à jour de librairies sous-jacentes, et vous pouvez d'ailleurs retrouver [la feuille de route ici](https://qgis.org/resources/roadmap/). Notons, à travers cette page [du nouveau site de QGIS](https://qgis.org/), qu'une nouvelle version "Long Terme Release" (3.40) est prévue pour... aujourd'hui! Cette mention à QGIS 4e version du nom est donc une liberté prise par Geotribu, dans l'optique d'essayer de répandre un peu de bonne humeur, en ces temps un peu troubles sur certains aspects.

Et en cartes (animées svp), puisque c'est quand même un peu notre boutique - aussi, ça donne ça:
...
- :elephant: [Travailler avec du JSON et PostgreSQL](../../articles/2025/2025-01-21_travailler-avec-JSON-et-PostgreSQL.md), un article de [Thomas](../../team/thomas-szczurek-gayant.md), qui explique comment foutre le zbeul de manière élégante dans le SGBD de l'éléphant

- :sunglasses: [Géobilan de 2024 et géovoeux 2025](../../articles/2025/2025-01-24_bilan-2024-voeux-2025.md), un article de [Julien](../../team/julien-moura.md), qui propose une rétrospective et des perspectives pour le site de la Geotribu

- :movie_camera: Bientôt une nouvelle série SIG sur OpenStreetMap Data 3D, en 5 articles, qui seront publiés tous les lundis du mois de mars. _Stay tuned!_
...
- :dancer: Les Balkans bientôt dans Geotribu! Avec un billet de blog sur le FOSS4G Bulgarie qui est en train de se monter, [sur `blog.geotribu.net`](https://blog.geotribu.net/), la déclinaison anglophone de Geotribu. À laquelle tout un chacun peut contribuer bien sûr, tout le monde est bienvenu, et peu importe le fuseau horaire. Pour célébrer ça, voici [une musique de BG](https://youtu.be/zwT4TZlMba0?feature=shared), vraiment. Bon, désolé hein...

C'est peut-être mieux d'annoncer cet heureux évènement avec la photo de groupe de l'année dernière:
...
De toutes façons, assez tardé dans cette intro qui tire décidément en longueur... Allez, c'est parti pour la RDP, à fond les :balloon: avec du [Goran Bregović](https://fr.wikipedia.org/wiki/Goran_Bregovi%C4%87), bonne lecture!

<iframe width="100%" height="400" src="https://www.youtube-nocookie.com/embed/iwvdzVEAZAU?si=n8rrhkQh7l5OqJW6" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
[Un billet de blog](https://blog.qgis.org/2025/02/08/qgis-recognized-as-digital-public-good/) sur le site de QGIS annonce que QGIS est dorénavant reconnu comme "Digital Public Good", qu'on pourrait traduire par "bien public numérique".

Cette distinction honorifique, décernée par la [Digital Public Good Alliance](https://www.digitalpublicgoods.net/), vient souligner les aspects suivants du projet QGIS (c'est repris du billet de blog):
