...
comments: true
date: 2025-06-13
description: "Une GeoRDP promptée comme jamais, avec aussi des trucs rédigés par des humains, et donc bourrés d'erreurs : une enquête sur la qualité de vos données géo, de la géo en Romandie, des nouvelles de la galaxie QGIS locale et globale, des tuiles, de l'art, et des vaches."
...
Cette semaine se sont déroulée les rencontres des utilisateurs francophones de QGIS, à Avignon. Organisées par [l'OSGeo-fr](https://www.osgeo.fr/), ces rencontres ont vu un programme varié et équilibré tenir en haleine les plus de 200 participant/es de cette année !

À Geotribu, en tant que partenaire communication de l'évènement, nous étions très heureux d'y participer, avec des bobs sur la tête, et aussi deux confs lors de la deuxième journée. Par [Guilhem](../../team/guilhem-allaman.md) sur [la génèse de QChat, un tchat dans QGIS et QField](https://slides.geotribu.net/2025-06-11_qchat_qgisfr2025.html), ainsi que [Julien](../../team/julien-moura.md) sur [la contribution à la culture de l'écosystème sur QGIS via l'expérience Geotribu](https://slides.geotribu.net/2025-06-11_qgisfr2025_geotribu-x-QGIS.html).

Le rendez-vous est déjà pris pour l'année prochaine, ce sera... à Brest !

Nous aimerions déjà proposer à [la boutique des goodies QGIS](https://conf.qgis.osgeo.fr/z55_qgis_shop.html#!/) la mise à disposition de cirés marins floqués QGIS :smirk:
