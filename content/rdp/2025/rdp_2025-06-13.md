...
Eh oui, Geotribu passe à la vitesse supérieure et entre de plein pied dans la modernité : cette GeoRDP a été rédigée à 100% avec de l'IA[^1] :sparkles::rocket::dizzy: ! Bonne lecture !
...
<!-- Footnotes reference -->
[^1]: Note: cette GeoRDP a été rédigée à 100% par des plumes avec un humain derrière, comme d'habituuuuuuuude :notes: ! Il y a ceci dit une news sur un plugin QGIS qui utilise de la GenAI, qu'on a eu envie d'essayer et qui pour être honnête ne nous a pas franchement convaincus (en 1 seul mot svp). L'accroche et l'intro sont donc plutôt ironiques, et ont pour intention d'essayer de montrer l'absurdité de la GenAI. On espère que vous apprécierez cette GeoRDP, n'hésitez pas à nous remonter vos avis & suggestions pour la prochaine !
