...
Voici une nouvelle chaîne Youtube de tutos QGIS francophones qu'on est contents de relayer : [Carte en main](https://www.youtube.com/@carteenmain), qui s'adresse aux débutants tout comme aux professionnels des SIGs, ou tout simplement aux passionné/es de la cartographie.
...
Ça tourne principalement autour de QGIS, alors abonne-toi et envoie des pouces bleus :thumbsup: !
...
Voici [un article en anglois](https://gogeomatics.ca/taking-control-of-canadas-digital-sovereignty-with-open-source-gis/), sur [GoGeomatics](https://gogeomatics.ca/), un "Resource Provider" de contenus pour la communauté géo au Canada, avec un site web qu'a pas l'air d'la chienne à Jacques.
