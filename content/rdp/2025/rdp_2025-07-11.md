...
![Nuage de points avec des noms d'artistes - crédits mixtape.cnrs.fr](https://cdn.geotribu.fr/img/articles-blog-rdp/divers/mixtape_accueil.webp)

Lancé il y a 14 ans environ, [plusieurs projets](https://mixtapes.cnrs.fr/projets-en-cours/) sont en cours au le laboratoire, _s’appuyanr sur des données hétérogènes et des méthodes mixtes, cherchant à mieux comprendre l’écoute de musique contemporaine et à développer des méthodes innovantes.

----

## En bref

- Sortie de QGIS 3.44 _Solothurn_ - c'est en :switzerland:, avec [ici le changelog](https://changelog.qgis.org/en/version/3.44/) de même que le visual changelog, en vidéo :
