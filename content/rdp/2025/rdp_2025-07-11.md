...
comments: true
date: 2025-07-11
description: "Voici la GeoRDP d'été, servie avec deux géoglaçons. À la recherche du Cartonaute, venez découvrir des tutos et autres truqs divers et variés."
...
Notons aussi [la publication des GeoInterview lors des dernières Rencontres QGIS-fr](#publication-des-vidéos-des-qgisfr2025), par [Florian](../../team/florian-boret.md) et [Julien](../../team/julien-moura.md) en collaboration avec l'équipe d'enseignement et les étudiant/es d'Avignon Université.
...
<iframe title="Vidéos des conférences aux Rencontres QGISFR2025" width="100%" height="400" src="https://video.osgeo.org/w/p/6FaxCxrrfstpaAoxzVH5dZ?playlistPosition=1" frameborder="0" allowfullscreen="" sandbox="allow-same-origin allow-scripts allow-popups allow-forms"></iframe>

Les GeoInterviews de participant/es aux Rencontres sont également publiées. Cette année, elles ont été réalisées par les étudiant/es d'Avignon Université, que nous remercions tout comme l'équipe d'encadrement. Ces GeoITW sont publiées par le compte de Geotribu, [sur PeerTube](https://video.osgeo.org/w/p/jFFXLPWMQurLfHZiNBy9JZ) notamment :

<iframe title="GeoITW des Rencontres QGISFR2025 en Avignon" width="100%" height="400" src="https://video.osgeo.org/w/p/jFFXLPWMQurLfHZiNBy9JZ?playlistPosition=1" frameborder="0" allowfullscreen="" sandbox="allow-same-origin allow-scripts allow-popups allow-forms"></iframe>
