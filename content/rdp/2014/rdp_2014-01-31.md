...
![icône WMS](https://cdn.geotribu.fr/img/logos-icones/divers/wms.png "icône WMS"){: .img-rdp-news-thumb }
...
[![Schéma WMS](https://cdn.geotribu.fr/img/articles-blog-rdp/webmapping/wms.png "Schéma WMS"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/webmapping/wms.png){: data-mediabox="lightbox-gallery" data-title="Schéma WMS" }
...
![logo Rue89](https://cdn.geotribu.fr/img/logos-icones/divers/rue89.jpg "logo Rue89"){: .img-rdp-news-thumb }
...
Aussi, rappelons [une rdp précédente](/rdp/2013/rdp_2013-09-06/) où nous parlions de l'Afrique malmenée par le système de projection Google Mercator. Nous y parlions d'une carte intitulée "La vraie taille de l'Afrique" où le Berceau du Monde parvenait en réalité à ceindre de son contour placentaire une multitude de pays.
...
[![Carte des créationniste au US - Slate](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/creationiste.png "Carte des créationniste au US - Slate"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/creationiste.png){: data-mediabox="lightbox-gallery" data-title="Carte des créationniste au US - Slate" }

### Datajournalisme et visualisation de données

![logo Geoconfluences](https://cdn.geotribu.fr/img/logos-icones/divers/Geoconfluence.png "logo Geoconfluences"){: .img-rdp-news-thumb }
...
![icône accessibilité](https://cdn.geotribu.fr/img/thumb.png "icône accessibilité"){: .img-rdp-news-thumb }
...
[![Accessibilité durant la période de pointe de 7h-9h du matin vers des zones d'emploi](https://cdn.geotribu.fr/img/articles-blog-rdp/divers/1.png "Accessibilité durant la période de pointe de 7h-9h du matin vers des zones d'emploi"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/divers/1.png){: data-mediabox="lightbox-gallery" data-title="Accessibilité durant la période de pointe de 7h-9h du matin vers des zones d'emploi" }
...
[![Bibliothèque USA](https://cdn.geotribu.fr/img/articles-blog-rdp/divers/bibliotheque_USA_MapBookshelf.jpg "Bibliothèque USA"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/divers/bibliotheque_USA_MapBookshelf.jpg){: data-mediabox="lightbox-gallery" data-title="Bibliothèque USA" }
