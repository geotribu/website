...
[![Schéma WMS](https://cdn.geotribu.fr/img/articles-blog-rdp/webmapping/wms.png "Schéma WMS"){: loading=lazy width=300px }](https://cdn.geotribu.fr/img/articles-blog-rdp/webmapping/wms.png){: data-mediabox="lightbox-gallery" data-title="Schéma WMS" }
{: align=middle }
