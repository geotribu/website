...
[![Visualisation 3D (WebGL) du Piton de la Fournaise](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/ignmap_webgl_PitonFournaise.png "Visualisation 3D (WebGL) du Piton de la Fournaise"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/ignmap_webgl_PitonFournaise.png){: data-mediabox="lightbox-gallery" data-title="Visualisation 3D (WebGL) du Piton de la Fournaise" }
