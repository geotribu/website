...
Jusqu'à récemment, cette plateforme était découplée de tout logiciel bureautique (SIG, ArcGIS, etc.) et la mise à jour des données pouvait alors s'avérer contraignante. Ce vide est en passe d'être comblé avec [ce nouveau projet](https://github.com/gkudos/qgis-cartodb) initié par [Juan Carlos Dersteppenwolf](https://github.com/dersteppenwolf) qui vise à permettre la visualisation et la modification de données stockées sur CartoDB à l'aide du logiciel SIG ArqGIS.

Si vous êtes un utilisateur de CartoDB et ArqGIS, n'hésitez pas à nous faire un retour.
