...
[![Menu d'OSGeo Live 8](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/osgeolive8_menu.png "Menu d'OSGeo Live 8"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/osgeolive8_menu.png){: data-mediabox="lightbox-gallery" data-title="Menu d'OSGeo Live 8" }

### Bootstrap et OpenLayers clés en main

![logo Bootstrap](https://cdn.geotribu.fr/img/logos-icones/programmation/bootstrap.jpg "logo Bootstrap"){: .img-rdp-news-thumb }
...
[![Template Bootstrap + OpenLayers](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/Bootstrap_OpenLayers_template_3col.Gif "Template Bootstrap + OpenLayers"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/Bootstrap_OpenLayers_template_3col.Gif){: data-mediabox="lightbox-gallery" data-title="Template Bootstrap + OpenLayers" }
...
<iframe width="100%" height="315" src="https://www.youtube-nocookie.com/embed/6EEhMBlux5g" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
![Globe cerveau](https://cdn.geotribu.fr/img/internal/icons-rdp-news/mentale.png "Globe cerveau"){: .img-rdp-news-thumb }
...
[![herehere](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/newyork_herehere.jpg "herehere"){: .img-center loading=lazy }](http://research.microsoft.com/en-us/news/features/herehere-031014.aspx)
...
[![Judgmental Maps](https://cdn.geotribu.fr/img/articles-blog-rdp/divers/judgmentalmaps.PNG "Judgmental Maps"){: .img-center loading=lazy }](http://judgmentalmaps.com/)
...
[![Itinéraires](http://geoawesomeness.com/wp-content/uploads/2014/08/Beautiful-cities.png "Itinéraires"){: .img-center loading=lazy }](http://geoawesomeness.com/the-new-algorithm-finds-the-most-beautiful-route-from-a-to-b/)
...
![logo MAGIS](https://cdn.geotribu.fr/img/logos-icones/entreprises_association/magis.png "logo MAGIS"){: .img-rdp-news-thumb }
...
[![Bannière de SAGEO 2014](https://cdn.geotribu.fr/img/articles-blog-rdp/divers/sageo2014.png "Bannière de SAGEO 2014"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/divers/sageo2014.png){: data-mediabox="lightbox-gallery" data-title="Bannière de SAGEO 2014" }
