...
![Menu d'OSGeo Live 8](https://cdn.geotribu.fr/img/articles-blog-rdp/capture-ecran/osgeolive8_menu.png)
...
<iframe src="//www.youtube.com/embed/videoseries?list=PLA6rqZ8wNITct8XBRDZ8_szGQ1ldxFT2Q" frameborder="0" width="560" height="315"></iframe>
...
![](https://cdn.geotribu.fr/img/icon_41293.png){: .img-rdp-news-thumb }

Le projet créé par Kati London consiste à récupérer les plaintes de voisinage émises à New York au travers de la ligne [311](http://www1.nyc.gov/311/).


Les e-mails, contenus des appels téléphoniques, textos sont scrutés et synthétisés sous la forme d'un tableau de bord sur la plate-forme du projet appelée [herehere](http://herehere.co/).


[![](http://research.microsoft.com/en-us/news/features/images/HereHere-NYC-map.jpg)](http://research.microsoft.com/en-us/news/features/herehere-031014.aspx)
...
*Traduit du site [Fast Co](http://www.fastcoexist.com/3027500/the-mood-of-every-nyc-neighborhood-based-on-their-311-complaints)*


### Des sensations à la carte

![](https://cdn.geotribu.fr/img/icon_41293_1.png){: .img-rdp-news-thumb }
...
[![](https://cdn.geotribu.fr/img/articles-blog-rdp/divers/judgmentalmaps.PNG)](http://judgmentalmaps.com/)Dans la même veine que ces outils-là, avec un degré de sophistication technologique moindre mais d'accessibilité du coup plus élevé, le portail [jdgmentalmaps](http://judgmentalmaps.com/) vous propose de lui soumettre vos cartes émotionnelles, c'est-à-dire des cartes sur lesquelles vous auriez consigné vos impressions, vos sensations concernant les pays, les villes, les quartiers qui vous auraient tenu à coeur.


### Virée bucolique

![](https://cdn.geotribu.fr/img/icon_41293_0.png){: .img-rdp-news-thumb }
...
*Traduit du site [geoawesomeness](http://geoawesomeness.com/the-new-algorithm-finds-the-most-beautiful-route-from-a-to-b/)*
...
[Google révèle son drone qui livre des colis](http://www.dailymotion.com/video/x24tfn2_google-revele-son-drone-qui-livre-des-colis_news) *par [lemondefr](http://www.dailymotion.com/lemondefr)*


<iframe src="//www.dailymotion.com/embed/video/x24tfn2" frameborder="0" width="480" height="270"></iframe>
...
![](https://cdn.geotribu.fr/img/logos-icones/divers/AncientMaps.jpg){: .img-rdp-news-thumb }

Non 113 n'est pas l'âge du site internet de la revue de géographie en ligne (qui elle a 30 ans), mais bien [son dernier numéro](http://mappemonde.mgm.fr/num41/index.html). Nous vous invitons à au moins aller jeter un oeil au sommaire et même à vous y abonner. Personnellement, j'ai bien aimé "[Ma petite géographie](http://mappemonde.mgm.fr/num41/articles/art14101.html)" qui propose une analyse des espaces vécus par les enfants. Voilà de quoi alimenter une rentrée scolaire rythmée par les débats...
