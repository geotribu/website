...
Un article sous forme de "proof of concept" ou de [jeux de style à la Georges Perec](http://fr.wikipedia.org/wiki/La_Disparition_%28roman%29) (parce qu'il y a bien des solutions plus simples pour chercher les zones plates hein :slightly_smiling_face:). (*source blog de [marcus Netler](http://courses.neteler.org/using-the-25m-eu-dem-for-shading-openstreetmap-layers/)*)
