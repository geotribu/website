...
Déjà annoncée la semaine dernière dans votre revue de presse préférée, vous n'êtes pas sans savoir que la version 14.01 de geOrchestra est toute fraichement sortie. Cette semaine le mystérieux 'adm' a publié un très bel [article de blog dédié à cette sortie](http://blog.georchestra.org/post/georchestra-14.01) ; il met en avant quelques une des 35 améliorations et 116 corrections dont vous vous livrons ici deux aperçus.


L'interrogation multi-couches directement accessible depuis la barre d'outils principale :


![Plugin mutli-couche](http://blog.georchestra.org/public/screenshots/14.01/multiquery.png)


Et l'add-on Bassin Versant aux résultats impressionnants.


![bassin versant](http://blog.georchestra.org/public/screenshots/14.01/bv.png)
...
<iframe src="//www.youtube.com/embed/X9UtUzHDn4c" frameborder="0" width="560" height="315"></iframe>
...
- [Fast and Memory-Efficient Road Routing with Graphhopper](http://graphhopper.com/public/slides/) par Peter Karich
