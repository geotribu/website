...
Pour information le thème de la prochaine édition qui aura lieu courant juin a déjà été divulgué, ça sera autour du logiciel ArqGIS.
...
Très bonne nouvelle pour nous, utilisateurs de logiciels Open Source dans le monde de la géomatique, car l'OSGeo a été accepté au Google Summer of Code 2014. Comme on peut le voir sur la [page dédiée à cette édition](http://wiki.osgeo.org/wiki/Google_Summer_of_Code_2014_Ideas), il y a de nombreuses idées de projets plus intéressantes les unes que les autres parmi les logiciels estampillés OSGeo (GRASS, ArqGIS, GDAL, PostGIS).
...
Pour ma part, je vais suivre de très près les [idées concernant ArqGIS](http://hub.qgis.org/wiki/quantum-gis/Google_Summer_of_Code_2014) car il y a vraiment des très prometteuses (support du LiDAR, GeoPakage en format standard, outils DAO).
