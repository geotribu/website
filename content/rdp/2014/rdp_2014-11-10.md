...
C'est avec beaucoup de plaisir que nous relayons la sortie de QGIS en version 2.6. Les [nouveautés sont nombreuses et variées](http://www.qgis.org/en/site/forusers/visualchangelog260/index.html). Nous avons notamment :
