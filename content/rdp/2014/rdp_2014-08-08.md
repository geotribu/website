...
Verser le tout sur du code informatique qu'il convient de plus en plus d'apprendre (comme R par exemple) et mélanger avec de la 3D. ArcGIS peut aisément être remplacé par ArqGIS.
