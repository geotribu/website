...
Avant d'entrer dans le vif du sujet, nous en profitons pour vous annoncer l'arrivée de Guillaume de Boyer alias [@\_Geopan](https://twitter.com/_Geopan) dans [l'équipe](../../team/gdbo.md). Installé au pays des kangourous, il nous fait l'honneur d'être des nôtres ! Merci Guillaume.
