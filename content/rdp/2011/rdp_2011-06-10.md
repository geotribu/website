...
### Géolocaliser des portes d'entrée**  
 Dans GeoWeb, il y a le mot Web. Cela signifie qu'on y trouve le meilleur comme le plus... Original. Je vous laisse seul juge de ce projet de [géolocalisation des portes d'entrée](http://frontdoor.cloudapp.net/) de bâtiments. La bonne nouvelle est que les données semblent également être partagées avec [OpenStreetMap](http://www.openstreetmap.org/).
...
### ZOO 1.2 RC1 est sorti**  
 ...
 ![ogc](http://www.geotribu.net/sites/default/files/Tuto/img/Blog/ogc.png){: .img-rdp-news-thumb }
