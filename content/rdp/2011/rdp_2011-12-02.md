...
Cette semaine, une grosse partie de notre revue de presse est dédiée à OpenStreetMap. Nous y aborderons notamment les dernières statistiques ou encore l'ajout de nouvelles couches. Mais rassurez-vous nous parlons également de la version 2.0 de Mapnik, de la mise à disposition de 450Tb de données ou encore du magnifique site Subjective Mapper.
...
![logo NASA](https://cdn.geotribu.fr/img/logos-icones/entreprises_association/nasa.png "NASA"){: .img-thumbnail-left }
