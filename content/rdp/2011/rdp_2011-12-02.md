...
### OpenStreetMap des chiffres et des besoins **  
 Dans la même semaine OpenStreetMap vient de franchir deux caps. Tout d'abord celui du nombre d'inscrits qui dépasse maintenant les [500000 utilisateurs](http://www.openstreetmap.org/stats/data_stats.html) (un demi-million ...). Puis celui du nombre d'éditions (changeset) qui atteint le chiffre pharaonique de [10 millions](http://www.openstreetmap.org/browse/changeset/10000000). Au-delà de ces chiffres qui montrent bien l'importance et la pérennité de ce projet, j'aimerais avant tout souligner que cela n'est possible que grâce à l’engagement de la communauté OSM.  
...
### Nouvelles couches dans/pour OSM**  
 Si vous vous êtes baladés sur [OpenStreetMap](http://www.openstreetmap.org/) récemment, vous avez peut-être remarqué l'ajout de 2 nouvelles couches dans le layer switcher, Transport Map et Mapquest Open.  
