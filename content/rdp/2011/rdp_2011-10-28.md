...
Certains pensent peut-être que nous nous concentrons trop sur les usages en ligne des SIG. Pour chercher à corriger cette idée, nous vous proposons de découvrir ce que fait ArqGIS et ce que certains font du logiciel. Ainsi nous vous proposons de lire [un point de vue](http://3liz.org/blog/rldhont/index.php/2011/10/27/373-journee-quantum-gis-2011) sur la rencontre ArqGIS francophone qui a eu lieu à Paris le 26 Octobre 2011. Nous vous proposons aussi de découvrir un exemple de projet qui utilise ArqGIS comme brique pour construire une application avec le projet [CAPS Scenario Builder](http://sourceforge.net/projects/osscripts/). Enfin, si vous n'êtes pas encore convaincu, pourquoi ne pas jeter un œil à une future fonctionnalité : le [constructeur de label](http://woostuff.wordpress.com/2011/10/27/expression-based-labeling/).

### D'autres solutions bureautiques OpenSource

![logo globe](https://cdn.geotribu.fr/img/internal/icons-rdp-news/world.png "Icône de globe"){: .img-thumbnail-left }

Pour une approche plus comparative avec d'autres solutions Opensource, nous vous conseillons d'aller sur [ce comparatif entre GRASS, ArqGIS et GvSIG](http://nosolosoftware.com/analysis-on-free-software-communities-i/) en espagnol (présenté dans un billet anglophone)  
