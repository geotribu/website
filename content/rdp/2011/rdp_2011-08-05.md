...
### MapCraft**  
 ...
 Si vous voulez l'installer sur votre serveur il suffit d'aller faire un tour sur [GitHub](https://github.com/Foxhind/MapCraft) - bon ok le [README](http://piratepad.net/YFP0rrxp4G) est en russe ... mais rien d'insurmontable n'est-ce-pas :)  
...
### Bien taguer un restau**  
 ...
 J'aurais juste ajouté un accent à Med Caf***é*** :) Mais bon, ce n'est pas facile à trouver sur un clavier anglophone.

 ![](http://wiki.openstreetmap.org/w/images/4/45/Med_cafe_tagging_example.png)

 *Merci à [Harry Wood](http://www.openstreetmap.org/user/Harry%20Wood/diary) !*
...
#### Data
 ...
 ![logoSandre.png](/sites/default/files/Tuto/img/Blog/logoSandre.png){: .img-rdp-news-thumb }
...
### BD Carthage 2011**  
 ...
 ![](/sites/default/files/Tuto/img/Blog/simplegeo.jpg)**SimpleGeo propose en téléchargement une base CC0**  
...
#### "Interop"
 ...
 ![](http://geotribu.net/sites/default/files/Tuto/img/Blog/divers/logo.jpg)**Inspire**  
...
### BeerMapping**  
 Espérons que le soleil soit avec nous ce mois d'août ... nous aurons donc besoin d'une application comme celle-ci : où trouver une bière bien fraîche ? Il suffit de choisir son pays, zoomer un peu et sélectionner un marqueur pour avoir des infos sur la brasserie :)  
 C'est par [ici](http://beermapping.com/brewery-maps/).




 ![biere_.png](/sites/default/files/Tuto/img/Blog/divers/nazca.gif)**Géoglyphes**  
 Lorsque j'étais enfant, je regardais le dessin animé "les mystérieuses cités d'or", on y voyait les géoglyphes de Nazca. Nous vous invitons à consulter [l'article wikipedia les abordant](http://fr.wikipedia.org/wiki/G%C3%A9oglyphes_de_Nazca). Plus récemment, un artiste, Andrew Rogers, a complété une oeuvre du même type après plus de 13 ans et qui est visible sur Google Earth. Nous vous invitons à visiter le [lien suivant pour en savoir plus](http://www.readwriteweb.com/archives/geoglyphs_google_captures_large-scale_earth_art.php) et/ou regarder la vidéo ci-dessous.
