 ...
 **Du nouveau pour Leaflet**![leaflet_upic_bigger.png](http://geotribu.net/sites/default/files/Tuto/img/Blog/divers/leaflet_upic_bigger.png)  
 [Leaflet](http://leaflet.cloudmade.com/), la librairie cartographique développée par Cloud Made, fait le plein de nouveautés cette semaine. Tout d'abord, il est désormais possible de l'intégrer facilement au CMS Drupal grâce [au module](<a%20href=%22http://drupal.org/project/leaflet%22>) spécifiquement développé. De plus, signalons également l'ajout d'un [gestionnaire de couche](http://leaflet.cloudmade.com/debug/control/control-layers.html). Il faut avouer que bien que récente, l'activité autour de ce projet est impressionnant !
 ...
 **Jaspa ou l'augmentation des fonctionnalités de traitement spatial en Java**![banner3.png](http://geotribu.net/sites/default/files/Tuto/img/Blog/divers/banner3.png)  
 ...
 **Quelques raisons de saliver sur les nouvelles versions de Mapserver et Spatialite**![](https://cdn.geotribu.fr/images/internal/icons-rdp-news/world.png)  
...
### OpenStreetMap : petit suivi
 ...
 Par ailleurs, vous pouvez aussi découvrir un projet qui vous permet d'avoir des fonctionnalités similaires à celle d'un serveur XAPI grâce à [OpenStreetMap Server Side Script](http://wiki.openstreetmap.org/wiki/OSM3S)




 **OpenData à tous les étages**![](https://cdn.geotribu.fr/images/internal/icons-rdp-news/world.png)  
 ...
 **CartoMouv', un site dédié à la cartographie dynamique**![](https://cdn.geotribu.fr/images/internal/icons-rdp-news/world.png)  
 ...
 **Evolution du style des cartes Google Maps**![Google Maps](https://cdn.geotribu.fr/images/logos-icones/entreprises_association/google/google_maps.png)  
 ...
 **Parce que c'est joli**![](https://cdn.geotribu.fr/images/logos-icones/divers/voronoi.png)  
 ...
 **Des présentations côté logiciels comme données**![](https://cdn.geotribu.fr/images/internal/icons-rdp-news/world.png)  
