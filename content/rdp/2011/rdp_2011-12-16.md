...
- ArqGIS sort en version 1.7.3. Plus que de la nouveauté, cette version se concentre sur les "bugfixes" et apporte quelques améliorations à GdalTools. Les informations détaillées concernant les changements sont disponibles sur [le blog officiel](https://www.qgis.org/en/about-qgis/qgis-releases.html).
...
![logo Map Icons](https://cdn.geotribu.fr/img/logos-icones/entreprises_association/mapicon.png "logo Map Icons"){: .img-thumbnail-left }
