...
ArqGIS ArqGIS ArqGIS - on attaque cette revue de presse avec le fameux logiciel SIG Open Source. Mais, rassurez vous nous aborderons également Python et Javascript, un peu d'Opendata, mais aussi de la sémiologie, NoSQL, et bien évidemment OSM !  
