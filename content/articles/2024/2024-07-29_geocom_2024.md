...
- [TimescaleDB](https://www.timescale.com/) : un PostgreSQL enrichi de capacités à traiter des séries temporelles (ce qui permettrait de facilement consolider des indicateurs par agrégation de données sur des périodes glissantes par exemple) ;
