...
- **Mise à jour des composants** : comme à l'accoutumée, cette version intègre des révisions des briques logicielles qui composent sont cœur : [GeoNetwork](https://www.geonetwork-opensource.org/), [GeoServer](https://geoserver.org/) et CAS notamment ;
...
- PostgreSQL enrichit de capacité à traiter des séries temporelles (ce qui permettrait facilement de consolider des indicateurs par agrégation de données sur des périodes glissantes par exemple) avec [TimescaleDB](https://www.timescale.com/) ;
