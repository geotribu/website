...
![Logo de Timescale](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/timescale-logo-name-black.png){: .img-center }

- [Timescale](https://www.timescale.com/) : un PostgreSQL enrichi de capacités à traiter des séries temporelles (ce qui permettrait de facilement consolider des indicateurs par agrégation de données sur des périodes glissantes par exemple) ;

![Logo de Superset](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/superset-logo.png){: .img-center }

- [Apache Superset](https://superset.apache.org/) pour exploiter les données collectées et produire des indicateurs et tableaux de bord.
