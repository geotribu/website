...
Scala et Groovy sont deux langages pour la [JVM](http://fr.wikipedia.org/wiki/Machine_virtuelle_Java), prévu pour être compilés en bytecode Java et exécutés sur la JVM.
...
* [http://fr.wikipedia.org/wiki/Scala\_%28langage%29](http://fr.wikipedia.org/wiki/Scala_%28langage%29)
