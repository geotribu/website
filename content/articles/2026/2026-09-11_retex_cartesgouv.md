...
La documentation suit la même règle, et l'ouverture ne porte pas que sur le code. Le [site d'aide](https://github.com/IGNF/cartes.gouv.fr-documentation) est un site statique généré avec [Eleventy](https://www.11ty.dev/), à partir du [template eleventy-dsfr de codegouvfr](https://github.com/codegouvfr/eleventy-dsfr), avec Pagefind pour la recherche. Surtout, les contributeurs de l'écosystème cartes.gouv.fr et Géoplateforme peuvent y publier leur propre documentation.
