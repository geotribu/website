...
Reprendre la carte du [tutoriel n°1](http://geotribu.net/node/12).  
...
Pour bien appréhender l'objet GControl(), il est nécessaire de se référer à l'API Google Maps - <http://code.google.com/apis/maps/documentation/reference.html#GControlImpl> - et aux articles Google Maps officiels - <http://code.google.com/apis/maps/documentation/controls.html#Custom_Controls>.
