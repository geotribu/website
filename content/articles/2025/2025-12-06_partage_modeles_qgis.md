...
Pour cela, rendez-vous dans "Settings" > "Options" > "Processing" > "Modèles" et ajoutez le chemin du répertoire partagé dans la liste des dossiers de modèles. Rapide et efficace ( merci à GeoJulien l’astuce ! ) !
