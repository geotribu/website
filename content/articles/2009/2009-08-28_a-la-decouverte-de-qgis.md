...
[![Quantum GIS Kore - Splash](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/qgis/qgis_logo_kore.jpg "Quantum GIS Kore - Splash"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/qgis/qgis_logo_kore.jpg){: data-mediabox="lightbox-gallery" data-title="Quantum GIS Kore - Splash" }
...
[![Quantum GIS Kore - Interface](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/qgis//qgis_interface.png "Quantum GIS Kore - Interface"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/qgis//qgis_interface.png){: data-mediabox="lightbox-gallery" data-title="Quantum GIS Kore - Interface" }

De plus il est possible de changer facilement le thème des icônes. L'image ci-dessous utilise le thème gis :

[![Quantum GIS Kore - Thème gis](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/qgis/theme_gis.png "Quantum GIS Kore - Thème gis"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/qgis/theme_gis.png){: data-mediabox="lightbox-gallery" data-title="Quantum GIS Kore - Thème gis" }
...
[![Quantum GIS Kore - Convertisseur OGR](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/qgis/convertisseur.png "Quantum GIS Kore - Convertisseur OGR"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/qgis/convertisseur.png){: data-mediabox="lightbox-gallery" data-title="Quantum GIS Kore - Convertisseur OGR" }
...
[![Quantum GIS Kore - Symbologie](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/qgis/style_layer.png "Quantum GIS Kore - Symbologie"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/qgis/style_layer.png){: data-mediabox="lightbox-gallery" data-title="Quantum GIS Kore - Symbologie" }
...
[![Quantum GIS Kore - Sélection spatiale](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/qgis/select_spatial.png "Quantum GIS Kore - Sélection spatiale"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/qgis/select_spatial.png){: data-mediabox="lightbox-gallery" data-title="Quantum GIS Kore - Sélection spatiale" }
...
[![Quantum GIS Kore - Sélection attributaire](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/qgis/select_attr.png "Quantum GIS Kore - Sélection attributaire"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/qgis/select_attr.png){: data-mediabox="lightbox-gallery" data-title="Quantum GIS Kore - Sélection attributaire" }
...
[![Quantum GIS Kore - Edition](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/qgis/edition.png "Quantum GIS Kore - Edition"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/qgis/edition.png){: data-mediabox="lightbox-gallery" data-title="Quantum GIS Kore - Edition" }
...
[![Quantum GIS Kore - Plugins](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/qgis/plugin.png "Quantum GIS Kore - Plugins"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/qgis/plugin.png){: data-mediabox="lightbox-gallery" data-title="Quantum GIS Kore - Plugins" }
...
[![Quantum GIS Kore - Outils GRASS](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/qgis/grass_0.png "Quantum GIS Kore - Outils GRASS"){: .img-center loading=lazy }](https://cdn.geotribu.fr/img/articles-blog-rdp/logiciels/qgis/grass_0.png){: data-mediabox="lightbox-gallery" data-title="Quantum GIS Kore - Outils GRASS" }
