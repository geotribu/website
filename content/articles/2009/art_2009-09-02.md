...
![holux_GPSport.jpg](https://cdn.geotribu.fr/img/OSM/holux_GPSport.jpg)Première difficulté trouver un GPS "tracker". Après avoir consulté [la liste](http://wiki.openstreetmap.org/wiki/GPS_Reviews) des GPS déjà testés par les équipes d'OSM, je me suis orienté vers le modèle GPSport 245 d'Holux.
