...
Google avec O3D a pour objectif de créer un nouveau standard Web. Mais, avec l'arrivée prochaine du HTML 5 et le développement de [Canvas 3D](https://web.archive.org/web/20111123110009/https://wiki.mozilla.org/Canvas:3D) (et également [3D Canvas JS Library](https://web.archive.org/web/20111123110009/http://www.c3dl.org/)), lequel de ces standards restera ?
