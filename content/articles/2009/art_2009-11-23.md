...
[![lebatlepluslaid.png](https://cdn.geotribu.fr/img/articles-blog-rdp/client/Google/lebatlepluslaid.png){: .img-center loading=lazy }](http://www.lebatimentlepluslaid.be/)

Vous trouvez horrible un bâtiment de votre quartier ou vous avez tout simplement envie de voir la maison de votre voisin détruite, alors ce site est fait pour vous. En réalité derrière ce coup de pub bien monté, se cache une entreprise de démolition qui propose de voter pour les bâtiments que vous jugez inesthétiques et qui gâchent le paysage. Leur philosophie est résumée par la quote ci-dessous :
...
[![helsinki_traffic.png](https://cdn.geotribu.fr/img/articles-blog-rdp/client/Google/helsinki_traffic.png){: .img-center loading=lazy }](http://transport.wspgroup.fi/hklkartta/defaultEn.aspx)

La logique est la même que pour le site précédent mais cette fois appliquée aux bus. Ces derniers, équipés d'un système de gélocalisation, transmettent en temps réel leur position géographique. Joli coup de pub pour la société [WSP](http://transport.wspgroup.fi/) qui distribue cette solution.

[![zurich_traffic.png](https://cdn.geotribu.fr/img/articles-blog-rdp/client/Google/zurich_traffic.png){: .img-center loading=lazy }](http://radar.zhaw.ch/radar.html)

Après la mer et la terre, prenons un peu de hauteur. C'est en tout cas ce que propose [L'université des sciences de Zurich](http://www.zhaw.ch/en/zurich-university-of-applied-sciences.html) au travers de son application cartographique qui permet de suivre, en temps réel et jusqu'à leur phase d'approche, la position des avions.

[![edinburgh_map.png](https://cdn.geotribu.fr/img/articles-blog-rdp/client/Google/edinburgh_map.png){: .img-center loading=lazy }](http://www.clairemurray.co.uk/edinburgh-map/)
Nos derniers exemples, bien que très bons techniquement, ne laissaient que peu de place à l'imagination. Alors face à la réalité d'un espace parfois un peu terne, Claire Murray propose sa propre vision de la ville d'Edinburgh. Le résultat est chaud, coloré et même un peu enfantin.

[![cassini_gmap.png](https://cdn.geotribu.fr/img/articles-blog-rdp/client/Google/cassini_gmap.png){: .img-center loading=lazy }](http://demo.geogarage.com/cassini/)
