...
[![logo Python](https://cdn.geotribu.fr/img/logos-icones/programmation/python.png "logo Python"){: loading=lazy width=100px }][![logo GDAL](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/gdal.png "logo GDAL"){: loading=lazy width=100px }]
{: align=middle }
