...
[![logo Python](https://cdn.geotribu.fr/img/logos-icones/programmation/python.png "logo Python"){: loading=lazy width=225px }](https://cdn.geotribu.fr/img/logos-icones/programmation/python.png "logo Python"){: data-mediabox="lightbox-gallery" data-title="logo Python"}
[![logo GDAL](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/gdal.png "logo GDAL"){: loading=lazy width=225px }](https://cdn.geotribu.fr/img/logos-icones/logiciels_librairies/gdal.png "logo GDAL"){: data-mediabox="lightbox-gallery" data-title="logo GDAL"}
