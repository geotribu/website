...
comments: true
date: 2021-11-11
description: 'Réalisez facilement une carte en relief du Parc National des Écrins avec des données IGN et ArqGIS. #30DayMapChallenge 2021.'
...
- d'un fond de carte
- et d'un logiciel SIG ([ArqGIS](https://www.qgis.org/fr/site/))
...
Ouvrez [ArqGIS](https://www.qgis.org/fr/site/) et faites glisser le fichier sur la fenêtre pour afficher cette limite.
...
Décompressez les fichiers chargés précédemment et faite glisser les fichiers `.asc` dans la fenêtre de ArqGIS.
Il vous faudra définir le système de coordonnées de référence (SCR) pour les données afin que ArqGIS sache comment placer ces fichiers sur la carte. Faites un clic-droit sur la couche pour définir le SCR.

![Menu définir le CRS](https://cdn.geotribu.fr/img/articles-blog-rdp/articles/carte_en_relief_des_ecrins/1-SCR.jpg "ArqGIS - Menu définir le CRS"){: .img-center loading=lazy }
...
Comme le parc est à cheval sur deux départements, le plus simple est de recopier les fichiers `.asc` des deux archives dans un même répertoire et de les faire glisser tous ensemble sur ArqGIS. On peut ensuite les sélectionner et changer leur SCR en une seule fois.
...
![Construire un VRT](https://cdn.geotribu.fr/img/articles-blog-rdp/articles/carte_en_relief_des_ecrins/3-merge.jpg "ArqGIS - Construire un VRT"){: .img-center loading=lazy }
...
![Dialogue construire un VRT](https://cdn.geotribu.fr/img/articles-blog-rdp/articles/carte_en_relief_des_ecrins/3-vrt.jpg "ArqGIS - Dialogue construire un VRT"){: .img-center loading=lazy }
...
Puis rendez-vous dans l'explorateur de ArqGIS à gauche pour ajouter une couche WMS/WMTS (clic-droit nouvelle connexion) et coller l'URL dans le champ dédié du dialogue.

![Charger les Géoservices](https://cdn.geotribu.fr/img/articles-blog-rdp/articles/carte_en_relief_des_ecrins/4-WMTS.jpg "ArqGIS - Charger les Géoservices"){: .img-center loading=lazy }

Dans notre cas, nous allons choisir le SCAN 50 historique qui a un rendu plutôt sympa.

![Scan 50 historique](https://cdn.geotribu.fr/img/articles-blog-rdp/articles/carte_en_relief_des_ecrins/5-scanhisto.jpg "ArqGIS - Scan 50 historique"){: .img-center loading=lazy }

----

## Passez dans la 3ème dimension

Pour cela, vous devrez ajouter une extension à ArqGIS.
...
Il vous suffit alors de cliquer sur la nouvelle icône ![Qgis2threejs](https://cdn.geotribu.fr/img/articles-blog-rdp/articles/carte_en_relief_des_ecrins/qgis2threejs.png "ArqGIS - Icône Qgis2threejs") (ou via le menu Internet).  
...
![Paramètres de la scène](https://cdn.geotribu.fr/img/articles-blog-rdp/articles/carte_en_relief_des_ecrins/6-scene.jpg "ArqGIS2ThreeJS Paramètres de la scène"){: .img-center loading=lazy }
...
![Propriétés de la couche](https://cdn.geotribu.fr/img/articles-blog-rdp/articles/carte_en_relief_des_ecrins/7-DEM.jpg "ArqGIS2ThreeJS Propriétés de la couche"){: .img-center loading=lazy }
